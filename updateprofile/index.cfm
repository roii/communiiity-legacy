...
<div style="width: 100%;">
  ...
  <cfif attributes.fusesubaction NEQ 'updateSkills'>       
								   ...
								   <!--- <td width="1" background="#request.imageroot#/dots_vertical.gif"><img src="#request.imageroot#/transparent_spc.gif" width="1" height="1" border="0"></td> 	--->
								    <td width="100%" style="padding-left:10px;padding-right:10px;" colspan="3"> 
										<cfif attributes.fusesubaction EQ 'index'>  
										       <cfinclude template="dsp_update_profile.cfm">
										<cfelseif attributes.fusesubaction EQ 'update'>
										       <cfinclude template="dsp_update_profile_result.cfm">	
										<cfelseif attributes.fusesubaction EQ 'updateemail'>
										       <cfinclude template="dsp_update_settings_email_result.cfm">	
										<cfelseif attributes.fusesubaction EQ 'updatepassword'>
										       <cfinclude template="dsp_update_settings_password_result.cfm">
										<cfelseif attributes.fusesubaction EQ 'deleteAcct'>
										       <cfinclude template="dsp_update_delete_account.cfm">	
										<cfelseif attributes.fusesubaction EQ 'updateSkills'>
										       <cfinclude template="dsp_update_skills_add_into_user.cfm">		      		   	    
										<cfelseif attributes.fusesubaction EQ 'savepic'>
										       <cfinclude template="dsp_save_profile_pic.cfm">	     
										</cfif>
							        </td>	
