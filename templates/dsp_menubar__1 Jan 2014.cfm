...
<div class="rowSet2">
  <div class="container clearfix"> 
	<cfif fusesubaction NEQ 'step2'>
		<cfif (IsDefined("URL.fuseaction") and URL.fuseaction eq 'projectss') or (IsDefined("URL.fuseaction") and URL.fuseaction eq 'tasks') or (IsDefined("URL.fuseaction") and URL.fuseaction eq 'followedproj')>
		<cfelse>
		    <table width="100%" cellpadding="0" cellspacing="0" border="0">
