							  ...
							  <cfif session.UserIsAuthenticated EQ 'Yes'>
								...
								&nbsp;
									<span style="color:##FFFFFF; font-family: Verdana,Geneva,sans-serif; font-size: small;">
									  or sign-up with <a href="javascript: void(0);" onclick="javascript: window.open('/getRequestToken.cfm','linkedIn Login','width=800,height=600,scrollbars=1,resizable=1');"> <img src="/images/linkedin-icon-footer.png" style="float: right; height: 20px; margin: 0; padding: 0;" /></a>
									</span> 
								</cfif> 
							  &nbsp;&nbsp;&nbsp;&nbsp; 
