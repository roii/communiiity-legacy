...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="6" border="0"><br>
	...
	<cfif session.permission1_view EQ 1>
		<tr>
		<td width="20" style="color:###session.AllSettings_BoxColour#;font-size:11px;" align="center"><strong>&raquo;</strong></td>
		<td width="187" style="font-size:11px;"><a href="#request.webroot#/index.cfm?fuseaction=administration&fusesubaction=manage_header" style="color:black;">Manage Header Section</a></td>
		</tr>
	</cfif>
	...
	<cfif session.permission1_view EQ 1>
		<tr>
		<td width="20" style="color:###session.AllSettings_BoxColour#;font-size:11px;" align="center"><strong>&raquo;</strong></td>
		<td width="187" style="font-size:11px;"><a href="#request.webroot#/index.cfm?fuseaction=administration&fusesubaction=manage_footer" style="color:black;">Manage Footer Section</a></td>
		</tr>
	</cfif>
