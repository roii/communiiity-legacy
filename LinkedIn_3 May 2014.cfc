...
<cfcomponent displayname="LinkedIn.cfc" hint="Functions to interact with LinkedIn API" output="yes">	
	<cfscript>
		variables.callback = "http://www.communautiii.com/CallBack.cfm"; // SET THIS TO THE FULL URL OF YOUR CALLBACK  
		variables.apiKey = "754gg76hqehhvq";
		variables.secretKey = "tgIw45jVdf1Zb9Qn";		
		//DO NOT CHANGE THESE
