...
<body>
<form name="amarForm" method="post" action="#request.webroot#/tasks/act_ExpressInterest.cfm">
	Project Id:&nbsp;&nbsp;<cfif isdefined("url.projectID")>#trim(url.projectID)#</cfif> <br>
	Project Name:&nbsp;&nbsp;<cfif isdefined("url.projectTitle")>#trim(url.projectTitle)#</cfif> <br>
...
onKeyUp="limitText(this.form.limitedtextarea,this.form.countdown,200);"></textarea><br>
	...
	<input type="Hidden" name="projectID" value="#trim(url.projectID)#">
