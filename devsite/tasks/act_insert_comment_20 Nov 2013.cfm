...
<cfset aResponse = listToArray(cfhttp.fileContent, chr(10))>
	...
	<cflocation url="#request.webroot#/index.cfm?fuseaction=projects&fusesubaction=docs&documentID=#form.documentID#&projectmode=#form.projectmode#&ProjectCategoryID=#form.ProjectCategoryID#&ProjectID=#form.projectID#">
<cfelse>
...
INSERT INTO ProjectComments(ProjectID, Comment, Author, AuthorEmail, DateAdded)

VALUES('#form.ProjectID#', '#cleanStr#', '#cleanAuth#', '#form.AuthorEmail#', GETDATE())

</cfquery> 

<cflocation url="#request.webroot#/index.cfm?fuseaction=projects">
