...
<cfcomponent displayname="Message" output="false" hint="I'm metadata information about a message that can be broadcast.">
  <cffunction name="init" returnType="ModelGlue.Metadata.Message" access="public" output="false" hint="I build a new Message.">
  ...
  <cffunction name="getArguments" access="public" returntype="struct" output="false" hint="I return the message's arguments (by value)">
