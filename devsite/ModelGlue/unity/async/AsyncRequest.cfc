...
<cffunction name="Init" output="false" returnType="ModelGlue.unity.async.AsyncRequest" hint="Constructor">
...
<cffunction name="GetEvent" output="false" returnType="ModelGlue.unity.eventrequest.EventContext">
