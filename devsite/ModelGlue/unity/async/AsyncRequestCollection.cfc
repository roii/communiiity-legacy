...
<cffunction name="Init" output="false" returnType="ModelGlue.unity.async.AsyncRequestCollection" hint="Constructor">
	<cfset variables.req = arrayNew(1) />
	<cfreturn this />
</cffunction>

<cffunction name="Add" output="false" returnType="void">
	<cfargument name="EventRequest" type="ModelGlue.unity.async.AsyncRequest" required="true">
