...
<cfmail bcc="alan@proworkflow.com" to="roy@mykidsbiz.com" from="#form.email#" subject="myKidsBiz.com - Bad Content Report" type="html">
<!DOCTYPE HTML Public "-//W3C//DTD HTML 4.01 Transitional//EN">

<html>
<head>
	<title>myKidsBiz.com - Bad Content Report</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>myKidsBiz.com - Bad Content Report</strong></span></td>
</tr>
