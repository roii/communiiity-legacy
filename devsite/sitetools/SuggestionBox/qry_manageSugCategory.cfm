...
<cfelseif add EQ 1>
	...
	<cfquery name="AddCategory" datasource="mykidsbiznewi" username="#request.username#" password="#request.password#">
...
<cfquery name="sugCategory" datasource="mykidsbiznewi" username="#request.username#" password="#request.password#">
		SELECT 	categoryID,
				convert(varchar(8),whenCategoryCreated,3) as [date],
				Name,
				Priority,
