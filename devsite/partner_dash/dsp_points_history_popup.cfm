...
<cflock Type="exclusive" scope="session" timeout="10">
	<cfparam name="session.DateRange_StartDate" default="#DateFormat(DateAdd('d', -31, localdatetime))#">
</cflock>

<cfif isdefined("DateRange_StartDate")>	
	<cflock Type="exclusive" scope="session" timeout="10">
		<cfset session.DateRange_StartDate = DateRange_StartDate>
	</cflock>
</cfif>
	

<cflock Type="exclusive" scope="session" timeout="10">
	<cfparam name="session.DateRange_EndDate" default="#DateFormat(DateAdd('d', 1, localdatetime))#">
</cflock>

<cfif isdefined("DateRange_EndDate")>	
	<cflock Type="exclusive" scope="session" timeout="10">
		<cfset session.DateRange_EndDate = DateRange_EndDate>
	</cflock>
</cfif>
...
AND contact_transactions.Related_Description <> ' '
AND contact_transactions.Transaction_Date >= #CreateODBCDate(session.DateRange_StartDate)#
AND contact_transactions.Transaction_Date <= #CreateODBCDate(session.DateRange_EndDate)#
...
<br>
	...
	<form method="post" action="#request.webroot#/partner_dash/dsp_points_history_popup.cfm" name="DateForm">
	<input type="hidden" name="this_organisationID" value="#this_organisationID#">
	<input type="hidden" name="MonthPoints_StartRow" value="1">
	
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td colspan="4"><strong>From:</strong>&nbsp; <input type="text" class="whitefields" name="DateRange_StartDate" value="#dateformat(session.DateRange_StartDate,'d mmmm yyyy')#"><!--- <a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.DateForm.DateRange_StartDate);return false;" hidefocus><img name="popcal" align="absmiddle" src="#request.imageroot#/calbtn.gif" width="34" height="22" border="0" alt=""></a> ---> &nbsp;<strong>To</strong>&nbsp; <input type="text" class="whitefields" name="DateRange_EndDate" value="#dateformat(session.DateRange_EndDate,'d mmmm yyyy')#"><!--- <a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.DateForm.DateRange_EndDate);return false;" hidefocus><img name="popcal" align="absmiddle" src="#request.imageroot#/calbtn.gif" width="34" height="22" border="0" alt=""></a> ---> &nbsp;&nbsp; <input type="submit" class="whitefield" value="Search">
	...
	<td align="right" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;::: View - <a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&MonthPoints_Maxrows=50&MonthPoints_StartRow=1">50</a> | <a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&MonthPoints_Maxrows=100&MonthPoints_StartRow=1">100</a> | <a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&MonthPoints_Maxrows=200&MonthPoints_StartRow=1">200</a></td>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	</tr>
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td style="font-size:11px;color:##444444;"><a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&SortBy=Transaction_Date&order=<cfif order EQ 'ASC'>DESC<cfelse>ASC</cfif>">Date</a></td>
	<td style="font-size:11px;color:##444444;"><a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&SortBy=ScreenName&order=<cfif order EQ 'ASC'>DESC<cfelse>ASC</cfif>">User</a></td>
	<td style="font-size:11px;color:##444444;"><a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&SortBy=Related_Description&order=<cfif order EQ 'ASC'>DESC<cfelse>ASC</cfif>">Activity</a></td>
	<td style="font-size:11px;color:##444444;" align="center"><a href="#request.webroot#/partner_dash/dsp_points_history_popup.cfm?this_organisationID=#this_organisationID#&SortBy=Transaction_Amount&order=<cfif order EQ 'ASC'>DESC<cfelse>ASC</cfif>">Earned</a></td>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	</tr>
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td style="font-size:11px;color:##444444;"><strong>#Dateformat(qry_points_month.Transaction_Date)# &nbsp;&nbsp; #Timeformat(qry_points_month.Transaction_Date, "HH:MM TT")#</strong></td>
