...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="2" border="0"><br>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Total Goals:</td>
	<td style="color:Black;font-size:11px;padding-right:5px;" align="center" width="100">#INT(totalActiveGoals + totalOverDueGoals + totalCompleteGoals)#</td>
	</tr>
