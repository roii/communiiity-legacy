									     ...
									     <td width="100%" style="padding-left:10px;padding-right:10px;"> 
											<cfif attributes.fusesubaction EQ 'index'>  
												<cfif session.UserIsAuthenticated EQ 'Yes'> 
													<cflocation url="#request.webroot#/index.cfm?fuseaction=contacts&fusesubaction=docs&documentID=44"> 
												<cfelse> 
													<cflocation url="#request.webroot#/index.cfm?fuseaction=contacts&fusesubaction=docs&documentID=54"> 
												</cfif>  
											<cfelseif attributes.fusesubaction EQ 'docs'>  
												...
												<cfelseif IsDefined("EditContact")>
													<cfinclude template="dsp_people_edit.cfm"> 
												<cfelseif documentID EQ '44'> 
													<cfinclude template="../templates/dsp_document_details.cfm">
													<cfinclude template="dsp_people_search.cfm"> 
												<cfelseif documentID EQ '45'> 
													<cfinclude template="../templates/dsp_document_details.cfm">
													<cfinclude template="dsp_people_add.cfm"> 
												<cfelseif documentID EQ '46'> 
													<cfinclude template="../templates/dsp_document_details.cfm">
													<cfinclude template="dsp_organisation_search.cfm"> 
												<cfelseif documentID EQ '53'> 
													<cfparam name="type" default="new"> 
													<cfif type EQ 'new'> 
														<cfinclude template="../templates/dsp_document_details.cfm">
														<cfinclude template="dsp_people_add.cfm"> 
													<cfelseif type EQ 'resend'> 
														<cfinclude template="../templates/dsp_document_details.cfm">
														<cfinclude template="dsp_resend_invite.cfm"> 
													</cfif>  
												<cfelse> 
													<cfinclude template="../templates/dsp_document_details.cfm">
