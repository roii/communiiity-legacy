...
<div class="fr tools">
	  <a class="fl embed white-button rounded" href="#request.webroot#/projects/createwidget/#campaignID#" oldtitle="Click to share on your website or blog" style="color: black; text-decoration: none;">
		#embedtext#</a> 
	  <a onclick="return true;" class="fl email white-button rounded" style="color: black; text-decoration: none;" href="mailto:roiipatterson@gmail.com?subject=#getCampaigns.TITLE#&amp;body=#Mid(TRIM(INTROTEXTData),1,400)#">#emailtext1Follow#</a> 
</div>
