...
<div class="fullwidth">
  <div class="leftwidth">
       <script language="javascript">
        ...
        <cfoutput>
		<a href="#request.webroot#/admin/dsp_campaigns_add.cfm?documentID=#documentID#" target="addArt" ONCLICK="fdbackwindow=window.open ('','addArt','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=700,height=450,top=10,left=10')" style="color:###TRIM(AllSettings.BoxColour)#; text-decoration:none;"><strong>#AddCampaigns# &raquo;</strong></a>  <br /><br />
	  	
	    <form name="filterform" action="#request.webroot#/index.cfm?fuseaction=campaigns&fusesubaction=docs&documentID=#documentID#&groupID=#groupID#" method="post" onsubmit="return checkform();">
									...
									<div class="project-details" style="word-wrap: break-word; color: black; height: 143px;"> 
										...
										<cfif #trim(ProjectDetails.location)# neq ''> 
									     ...
									     <div style="border-top: 1px solid ##808080; margin-top: 12px; height: 60px; padding-left: 10px;">
											 ...
											 <a href="#request.webroot#/admin/dsp_campaigns_edit.cfm?projectID=#ProjectDetails.projectID#&documentID=#documentID#" target="editArt" ONCLICK="fdbackwindow=window.open ('','editArt','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=700,height=450,top=10,left=10')"><img src="#request.imageroot#/but_edit_icon.gif" width="10" height="10" alt="Edit this Project" border="0"></a> <a href="javascript:confirmProjectDelete('#request.webroot#/admin/act_campaigns_delete.cfm?projectID=#ProjectDetails.projectID#&documentID=#documentID#')"><img src="#request.imageroot#/but_delete_icon.gif" width="10" height="10" alt="Delete this Project" border="0"></a>
										 </div>
