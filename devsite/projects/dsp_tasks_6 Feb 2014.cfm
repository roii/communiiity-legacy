...
<cfset filename = langFilesStr[1]["#defaultlang#"]> 
  ...
  <cfif session.UserIsAuthenticated EQ 'Yes'>
		 <cfoutput>
			<a href="#request.webroot#/index.cfm?fuseaction=projects&fusesubaction=addTask&pid=#campaign_id#&documentID=#documentID#" style="color:###TRIM(AllSettings.BoxColour)#; text-decoration:none;"><strong>#AddNewTask# &raquo;</strong></a>  <br /><br />
		 </cfoutput>  	
  </cfif>			
