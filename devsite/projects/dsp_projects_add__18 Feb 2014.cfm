...
function validateForm(addform) {
	...
	if(totalcheckbxs <= 0)
	{
	    alert("You must select a Category for this project."); 
		return false;
	} 
	...
	{   
	    alert("Required: You must have to either enter the Video URL or select the Image for the Project");
	...
	{   
	    alert("Required: You must have to enter the Video URL for the Project");
		addform.campaign_video.focus();
		return false; 
	}
	else if(document.getElementById('media_proj_img').checked == true && addform.primary_picture.value == "")
	{   
	    alert("Required: You must have to select the Project Image");
								        ...
								        <table cellpadding="0" cellspacing="0" border="0" width="100%">
										    <tr>
											      <td valign="top" width="10%">
												          <input type="checkbox" name="ProjectCategoryID" value="#TRIM(allCats.ProjectCategoryID)#" />
												  </td>
