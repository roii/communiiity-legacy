...
<cfparam name="sections_Srow" default="1">
<cfparam name="sections_Mrow" default="10">


<!--- SET END ROW VALUE --->

<cfif #SectionResults.RecordCount# GT (#sections_Srow#+#sections_Mrow#)-1>
	<cfset sections_endrow = #sections_Srow#+#sections_Mrow#-1>
<cfelse>
	<cfset sections_endrow = #SectionResults.RecordCount#>
</cfif>


<!--- SET THE PREV VALUE --->
	<cfif #sections_Srow# GT #sections_Mrow#>
		<cfset sections_prev = #sections_Srow#-#sections_Mrow#>
	
	<cfelse>
		<cfset sections_prev = #sections_Srow#>
	...
	<!--- SET THE NEXT VALUE --->
	<cfif #sections_endrow# LT #SectionResults.RecordCount#>
		<cfset sections_next = (#sections_endrow#+1)>
	
	<cfelse>
		<cfset sections_next = #sections_Srow#>
...
<td valign="top" <cfif #session.textonly# EQ 'yes'>bgcolor="black"<cfelse>bgcolor="#TRIM(sectionDetails.barColor)#"</cfif>><span style="color:white; letter-spacing:.5em;"><strong>&nbsp;SECTION RESULTS</strong></span></td>
</tr>
...
<td valign="top" bgcolor="e2e2e2">
	...
	<tr>
	<td><cfif #sectionresults.recordcount# GT 0>Your search retrieved: <b>#sectionresults.recordcount#</b> section results.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Displaying records: <strong>#sections_srow# - #sections_endrow#<cfelse>No sections found matching your search criteria</cfif></strong></td>
	</tr>
...
<cfif #sectionresults.recordcount# GT 0>
...
<td valign="top" bgcolor="f4f4f4"><img src="#request.imageroot#/transparent_spc.gif" width="2" height="5" border="0"><br>
	...
	<cfloop query="sectionresults" startrow="#sections_Srow#" endrow="#sections_endrow#">
	<tr>
	<td width="40">&nbsp; #sectionresults.currentrow#</td>
	<td width="100%"><a href="#request.webroot#/index.cfm?fuseaction=#sectionresults.fuseaction#" style="color:blue;">#sectionresults.Title#</a></td>
	</tr>
	</cfloop>
...
<td valign="middle" bgcolor="e2e2e2">
	...
	<td width="40">
	<INPUT type="hidden" name="sections_mrow" value="#sections_mrow#">
	<INPUT type="hidden" name="sections_Srow" value="#Evaluate(sections_Srow - sections_mrow)#">
	...
	<cfif #sectionresults.recordcount# gt (#sections_mrow#+#sections_Srow# -1)>
	<FORM action="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=#fusesubaction#" method="post">
