...
<cfquery name="CurrentStuff" datasource="#dsn#" username="#request.username#" password="#request.password#">
SELECT *
FROM SugCategory
WHERE CategoryID=#currentcategory#
</cfquery>

<cfquery name="CurrentSponsor" datasource="#dsn#" username="#request.username#" password="#request.password#">
