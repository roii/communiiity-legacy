...
<tr>
<td class="page_header" width="100%">#UCASE(DocumentDetails.Title)# - Current</td>
...
<td colspan="2"><br>
	...
	<cfif (#session.UserIsAuthenticated# EQ 'yes') AND (#session.UserType# EQ 'Administrator')>
		...
		<cfoutput>
		<tr>
		<td class="small" colspan="2"><a href="#request.webroot#/admin/dsp_newsCat_add.cfm?fuseaction=#fuseaction#<cfif IsDefined("attributes.fusesubaction")>&fusesubaction=#attributes.fusesubaction#</cfif><cfif IsDefined("attributes.documentID")>&documentID=#attributes.documentID#</cfif><cfif IsDefined("attributes.ArticleID")>&ArticleID=#attributes.ArticleID#</cfif>" target="addNewsCat" ONCLICK="fdbackwindow=window.open ('','addNewsCat','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=700,height=235,top=10,left=10')" style="color:red; text-decoration:none;"><strong>ADD A CATEGORY &raquo;</strong></a> &nbsp;&nbsp;&nbsp; <a href="#request.webroot#/admin/dsp_news_add.cfm?fuseaction=#fuseaction#<cfif IsDefined("attributes.fusesubaction")>&fusesubaction=#attributes.fusesubaction#</cfif><cfif IsDefined("attributes.documentID")>&documentID=#attributes.documentID#</cfif><cfif IsDefined("attributes.ArticleID")>&ArticleID=#attributes.ArticleID#</cfif>" target="addNews" ONCLICK="fdbackwindow=window.open ('','addNews','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=700,height=450,top=10,left=10')" style="color:red; text-decoration:none;"><strong>ADD AN ARTICLE &raquo;</strong></a><br><br></td>
		</tr>
		</cfoutput>
	...
	<cfinclude template="../default_news/qry_current_news.cfm">
	
	<cfif (#headlines.recordcount# GT 0) OR (#session.UserIsAuthenticated# EQ 'yes') AND (#session.UserType# EQ 'Administrator')>
		
		<tr>
		<td><ul><li class="normal" style="color:#TRIM(sectionDetails.barColor)#;"><a href="###NewsCatName#" style="color:gray; text-decoration:none;">#TRIM(NewsCatName)#</a> <span class="small">(#headlines.recordcount#)</span></li></ul></td>
		<cfif (#session.UserIsAuthenticated# EQ 'yes') AND (#session.UserType# EQ 'Administrator')>
	...
	<cfinclude template="../default_news/qry_current_news.cfm">
		...
		<td class="normal" width="17" valign="top" align="center"><font face="webdings" size="2" color="#TRIM(sectionDetails.barColor)#">4</font></td>
		<td width="7"><img src="#request.imageroot#/transparent_spc.gif" width="7" height="1" border="0"></td>
		<td class="normal" style="color:gray;">No current news articles available. Click here to view the <a href="#request.webroot#/index.cfm?fuseaction=#attributes.fuseaction#<cfif IsDefined("attributes.fusesubaction")>&fusesubaction=#attributes.fusesubaction#</cfif><cfif IsDefined("attributes.documentID")>&documentID=#attributes.documentID#</cfif><cfif IsDefined("attributes.ArticleID")>&ArticleID=#attributes.ArticleID#</cfif>&newsmode=archive" style="color:Gray;">News Archive &raquo;</a></td>
		</tr>
