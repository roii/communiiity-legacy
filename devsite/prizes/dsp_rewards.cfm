...
<a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=50" style="color:###TRIM(AllSettings.BoxColour)#;">#clickherehotlink#</a> #toseehowearn#.<cfif session.UserIsAuthenticated EQ 'Yes'><br><br>
#currentBal#: <span style="color:###TRIM(AllSettings.BoxColour)#;"><strong>#thistotal# #pts#</strong></span></cfif><br>
<img src="#request.imageroot#/transparent_spc.gif" width="1" height="4"  border="0"> 
	<hr width="100%" size="1" color="##b4b4b4">  
	<br />
	<form name="filterRewardsform" action="#request.webroot#/index.cfm?fuseaction=prizes&fusesubaction=docs&documentID=#documentID#" method="post">
	<div>
	...
	<input type="button" value="#resetS# &gt;&gt;" class="buttonControl" style="cursor: pointer;" onclick="javascript: window.location = '#request.webroot#/index.cfm?fuseaction=prizes&fusesubaction=docs&documentID=#documentID#';" name="go">
	<br />
	</form>
	<br />  
