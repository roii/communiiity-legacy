<cfif IsDefined("FORM.upload_avtar") and FORM.upload_avtar neq ''>  
  <!---Upload and save image to server--->
        ...
        <cfimage source="#myImage1#" action="write" destination="D:/home/crowdsourciiing.com/wwwroot/images/profiles/small_#fileName#" overwrite="yes">
		...
		<!--- Save the modified image to a file called "test_myImage.jpeg" and display the image in a browser. --->
        <cfimage source="#myImage#" action="write" destination="D:/home/crowdsourciiing.com/wwwroot/images/profiles/#fileName#" overwrite="yes"> 
		
		<cfset updateStatus = "success">
<cfelseif IsDefined("FORM.FILENAMETOCANCEL") and FORM.FILENAMETOCANCEL neq ''>  	
 
        <cfset largeFile = "D:/home/crowdsourciiing.com/wwwroot/images/profiles/#FORM.FILENAMETOCANCEL#">
        <cfset FileDelete(#largeFile#)>
		<cfset smallFile = "D:/home/crowdsourciiing.com/wwwroot/images/profiles/small_#FORM.FILENAMETOCANCEL#">
