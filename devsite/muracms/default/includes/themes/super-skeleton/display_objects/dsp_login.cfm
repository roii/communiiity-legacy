...
<div id="svLoginContainer">
	...
	<#$.getHeaderTag('subhead4')#>#$.rbKey('user.pleaselogin')#</#$.getHeaderTag('subhead4')#>
		...
		<fieldset>
			<ol>
				...
				<li>
					...
					<label for="cbRememberMe" class="checkbox">#htmlEditFormat($.rbKey('user.rememberme'))#</label>
				</li>
			</ol>
			<div class="buttons">
	...
	<form name="form2" method="post" action="?nocache=1" id="sendLogin" onsubmit="return validate(this);" novalidate="novalidate">
		<fieldset>
			<#$.getHeaderTag('subhead4')#>#$.rbKey('user.forgetusernameorpassword')#</#$.getHeaderTag('subhead4')#>
	...
	<div id="notRegistered">
		<#$.getHeaderTag('subHead3')#>#$.rbKey('user.notregistered')# <a class="button" href="#$.siteConfig('editProfileURL')#&returnURL=#urlencodedformat($.event('returnURL'))#">#$.rbKey('user.signup')#.</a></#$.getHeaderTag('subHead3')#>
	</div>
	</cfif>
