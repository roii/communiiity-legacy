...
<cffunction name="getProjectsList" access="public" returntype="any" returnformat="plain" output="true">
	...
	<cfquery name="records" datasource="#arguments.datasource#">
	...
	<cfquery name="this_page" datasource="#arguments.datasource#"> 
	...
	<cfloop query="this_page"> the grid wants the data inthis format [id,cell{column,column...}]
		...
		<cfset tmp2.cell[1] = this_page.ProjectID>
		...
		<cfset tmp2.cell[6] = #INT(this_page.CreditsOffered)#>
