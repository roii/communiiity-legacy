...
<html>
<head>
	<title>#TRIM(AllSettings.SiteName)# - Add Reward</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add Reward</strong></span></td>
</tr>
...
<br>
	...
	if (editPrize.name.value == "") {
		alert("You must enter a Name for this reward.");
	...
	<form name="editPrize" action="#request.webroot#/administration/act_add_reward.cfm" method="post" enctype="multipart/form-data">
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td class="normal" valign="top" width="110">Reward Description</td>
	...
	<td Class="normal" valign="top"><input type="text" Class="small" size="15" name="Quantity"></td>
	</tr>		
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td>Display</td>
	<td><input type="radio" Class="whitefield" name="Display" checked value="1"> Yes &nbsp;&nbsp;&nbsp; <input type="radio" Class="whitefield" name="Display" value="0"> No</td>
	</tr>		
	...
	<td><input type="radio" Class="whitefield" value="1" name="PromoteOnSide" checked> Yes &nbsp;&nbsp; <input type="radio" Class="whitefield" value="0" name="PromoteOnSide"> No</td>
	</tr>		
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td><input type="submit" onclick="javascript:validate(editPrize); return false;" value="ADD REWARD NOW >>" class="whitefield"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
