...
<html>
<head>
	<title>#TRIM(AllSettings.SiteName)# - Add Partner</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add Partner</strong></span></td>
</tr>
...
<br>
	...
	<form name="AddCharity" action="#request.webroot#/administration/act_add_partner.cfm" method="post" onsubmit="javascript:validate(AddCharity); return false;">
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td><input type="submit" value="ADD PARTNER NOW >>" class="whitefield"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
