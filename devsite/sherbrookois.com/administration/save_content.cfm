...
<cfabort>
 ...
 <cfif #FORM.HEADER# eq 1>
	 <cfquery name="getContent" datasource="#dsn#" username="#request.username#" password="#request.password#">
	   UPDATE site_section_contents_data SET header = '#FORM.EDITOR1#' WHERE section_id = 1
	 </cfquery>
 <cfelse>
     <cfquery name="getContent" datasource="#dsn#" username="#request.username#" password="#request.password#">
	   UPDATE site_section_contents_data SET footer = '#FORM.EDITOR1#' WHERE section_id = 1
	 </cfquery>
 </cfif>
 ...
 <cflocation url="/index.cfm?fuseaction=#URL.fuseaction#&fusesubaction=#URL.fusesubaction#&secti=#FORM.HEADER#" addtoken="no">
