...
<td style="font-size:12px;"><a href="#request.webroot#/administration/dsp_edit_charity_popup.cfm?OrganisationID=#OrganisationID#&updatemode=addstaff" style="color:###TRIM(AllSettings.BoxColour)#;"><strong>ADD A STAFF MEMBER</strong></a></td>
...
<td width="40" align="right"><a href="#request.webroot#/administration/dsp_edit_charity_popup.cfm?OrganisationID=#OrganisationID#&updatemode=editstaff&contactID=#AllStaff.ContactID#"><img src="#request.imageroot#/but_edit_icon.gif" width="10" height="10" alt="Edit Staff Member" border="0"></a>&nbsp;<a href="javascript:confirmStaffDelete('#request.webroot#/administration/act_delete_staff.cfm?OrganisationID=#OrganisationID#&contactID=#AllStaff.ContactID#')"><img src="#request.imageroot#/but_delete_icon.gif" width="10" height="10" alt="Delete Staff Member" border="0"></a></td>
<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
</tr>
