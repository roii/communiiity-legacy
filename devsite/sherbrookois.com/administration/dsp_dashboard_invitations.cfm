...
<td>
	...
	<tr bgcolor="d8d8d8">
	<td style="color:Black;font-size:11px;padding-left:5px;padding-top:4px;">Total Invitations:</td>
	...
	<td style="color:Black;font-size:11px;padding-left:5px;">Total Successful:</td>
	<td style="color:Black;font-size:11px;padding-right:5px;" align="center" width="100">#total_Successful_Invitations#</td>
	</tr>
	
	<tr bgcolor="d8d8d8" height="20">
	<td style="color:Black;font-size:11px;padding-left:5px;padding-bottom:4px;">Overall Success Rate:</td>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Date Range Invitations:</td>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Date Range Successful:</td>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Date Range Success Rate:</td>
