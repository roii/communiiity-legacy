...
<form name="TeacherReg" action="#request.webroot#/administration/act_add_teacher.cfm" method="post">
...
<td style="font-size:11px;color:##444444;"><input type="text" name="FirstName" class="whitefield" style="width:300px;"></td>
</tr>

<tr>
<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
<td style="font-size:11px;color:##444444;" width="110"><strong>Last Name</strong></td>
<td style="font-size:11px;color:##444444;"><input type="text" name="LastName" class="whitefield" style="width:300px;"></td>
</tr>
...
<td style="font-size:11px;color:##444444;"><input type="text" name="EmailAddress" class="whitefield" style="width:300px;"></td>
</tr>
...
<td style="font-size:11px;color:##444444;"><input type="Password" name="Profile_Password" class="whitefield" style="width:300px;"></td>
</tr>

<tr>
<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
<td style="font-size:11px;color:##444444;" width="110"><strong>Confirm Password</strong></td>
<td style="font-size:11px;color:##444444;"><input type="Password" name="ConfirmPassword" class="whitefield" style="width:300px;"></td>
</tr>
...
<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
<td> </td>
<td style="font-size:11px;color:##444444;"><input type="submit" onclick="javascript:validateProfile(TeacherReg); return false;" value="ADD NOW >>" class="whitefield"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
</tr>
