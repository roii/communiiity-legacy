...
<br>
	...
	<form name="AddSchool" action="#request.webroot#/administration/act_add_school.cfm" method="post" enctype="multipart/form-data">
	...
	<td><input type="text" name="SchoolName" class="whitefield" style="width:300px;"></td>
	</tr>
	...
	<td><input type="text" name="Phone" class="whitefield" style="width:300px;"></td>
	</tr>
