...
<cfif IsDefined("form.Delete_#loopcount#") AND #Evaluate("form.Delete_" & loopcount)# EQ 1>
	...
	<!--- DELETE IDEA --->
	<cfquery name="RemoveSug" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r" maxrows="1">
	DELETE
	FROM Suggestion
...
<cfelse>
	...
	<cfquery name="moveidea" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r" maxrows="1">
	UPDATE Suggestion
