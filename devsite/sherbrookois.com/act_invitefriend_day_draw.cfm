...
VALUES(#newid#, 'Day', #CreateODBCDate(localdatetime)#, #CreateODBCDate(DateAdd('d', 1, localdatetime))#, 0, '', 2000, 0, 0)
 </cfquery>
...
<cfmail server="#application.emailserver#" to="alan@my3p.com" cc="roy@my3p.com" from="website@my3p.com" subject="Invite Friend- Daily Draw successful" type="html">
RESULTS<br><br>
