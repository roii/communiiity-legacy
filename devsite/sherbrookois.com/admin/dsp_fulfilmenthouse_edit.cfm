...
<cfquery name="FulfilmentDetails" datasource="#dsn#" username="#request.username#" password="#request.password#">
SELECT *
...
<br>
	...
	<form method="post" action="#request.webroot#/admin/act_fulfilmenthouse_edit.cfm" name="AdministratorAddForm">

	<input type="hidden" name="fulfilmenthouseID" value="#fulfilmenthouseID#">
	...
	<td class="normal" valign="top"><input name="BusinessName" class="whitefield" style="width:350px;" value="#FulfilmentDetails.BusinessName#"></td>
	</tr>
	...
	<td class="normal" valign="top"><input name="ContactName" class="whitefield" style="width:350px;" value="#FulfilmentDetails.ContactName#"></td>
	</tr>
	...
	<td class="normal" valign="top"><input name="EmailAddress" class="whitefield" style="width:350px;" value="#FulfilmentDetails.EmailAddress#"></td>
	</tr>
	...
	<td class="normal" valign="top"><input name="PhoneNumber" class="whitefield" style="width:350px;" value="#FulfilmentDetails.PhoneNumber#"></td>
	</tr>
	...
	<td class="normal" valign="top"><textarea name="Address" class="whitefield" style="width:350px;" rows="6">#FulfilmentDetails.Address#</textarea></td>
	</tr>
