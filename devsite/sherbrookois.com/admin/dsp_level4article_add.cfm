...
if (addform.Level4ArticleTitle.value == "") {
	alert("You must enter a Title for this Level4Article.");
	addform.Level4ArticleTitle.focus();
	return;
	} 
	
else if (addform.DisplayOrder.value == "") {
	alert("You must enter a Display Order for this Level4Article.");
...
<html>
<head>
	<title>MyKidsBiz - Add Level 5 Document</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add Level 5 Document</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_level4article_add.cfm" name="addform">
	...
	<td class="normal" valign="top"><textarea class="whitefield" cols="85" rows="2" name="level4articleTitle"></textarea></td>
	</tr>
	...
	<textarea name="Level4Details" rows="20" cols="40"></textarea>
	<!---	
	...
	<td Class="normal" valign="top"><input type="text" Class="whitefield" size="68" name="Level4ExpireDate"> &nbsp; <a href="#request.webroot#/templates/dsp_pop_calendar.cfm?Field=Level4ExpireDate&formName=addform&Enc=No" target="popcalendar" ONCLICK="fdbackwindow=window.open ('','popcalendar','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0,width=160,height=140,top=50,left=50')" style="color:black; text-decoration:none;">Calendar >></a></td>
	</tr>		
	...
	<td Class="normal" valign="top"><input type="radio" Class="whitefield" name="Level4Released" value="1"> Yes &nbsp;&nbsp;&nbsp;<input type="radio" Class="whitefield" name="Level4Released" value="0" checked> No</td>
	</tr>		
