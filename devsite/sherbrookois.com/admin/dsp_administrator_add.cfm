...
<html>
<head>
	<title>MyKidsBiz - Add an Administrator</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add an Administrator</strong></span></td>
</tr>
