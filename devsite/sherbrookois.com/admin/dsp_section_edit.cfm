...
if (editsection.title.value == "") {
	alert("You must enter a Title for this section.");
	editsection.title.focus();
	return false;
	}
	
else if (editsection.menutitle.value == "") {
	alert("You must enter a Menu Title for this section.");
	editsection.menutitle.focus();
	return false;
	}
...
<br>
	...
	<form method="post" action="#request.webroot#/admin/act_section_edit.cfm" name="editsection">
	...
	<td><input type="text" name="title" style="width:600px;font-size:10px;font-family:Arial;" value="#TRIM(SectionStuff.title)#" class="whitefield"></td>
	</tr>
	
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td width="120">Menu Title</td>
	<td><input type="text" name="menutitle" style="width:600px;font-size:10px;font-family:Arial;" value="#TRIM(SectionStuff.MenuTitle)#" class="whitefield"></td>
	</tr>	
...
<cfif SectionStuff.fuseaction CONTAINS 'Homepage'>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td></td>
	<td><input type="submit" style="font-size:10px;font-family:Arial;" value="UPDATE NOW >>>" onClick="javascript:ae_onSubmit(); validate(editsection); return false;" class="whitefield"> &nbsp; <input type="button" onClick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
