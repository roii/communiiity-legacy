...
if ( !bImageButton && !FCKConfig.ImageDlgHideLink )
	window.parent.AddTab( 'Link', 'Link' ) ;	// TODO: Localizability.
...
function Browseblogimages()
{
	OpenServerBrowser(
		'Image',
		'http://www.friendsnet.cn/blog/index.cfm?action=blogphoto',
		FCKConfig.ImageBrowserWindowWidth,
		FCKConfig.ImageBrowserWindowHeight ) ;
}
