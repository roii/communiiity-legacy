...
<br>
	...
	<form method="post" action="act_cashprojectcat_edit.cfm">
	...
	<td class="normal" valign="top"><select name="GroupID" class="whitefield" style="width:300px;"><cfloop query="qry_groups"><option value="#TRIM(qry_groups.GroupID)#"<cfif catdetails.GroupID EQ qry_groups.GroupID> selected</cfif>>#TRIM(qry_groups.GroupName)#</cfloop></select></td>
	</tr>
