...
<cfloop query="recordset" startrow="#startrow#" endrow="#endrow#">
		...
		<cfloop index="Index_Column" list="#columns#">
		 ...
		 <form action="default.cfm" method="post" onsubmit="javascript:return confirm('Warning!!! You are  about to delete this result from the system!!! You will lose all your data after this transaction!!! Are you sure???')">
		<td>
		<input type="hidden" name="at" value="6">		
		<input type="hidden" name="obj" value="116">
		<input type="hidden" name="itemid" value="#itemid#">
		<input type="hidden" name="formid" value="#formid#">		
...
<cfoutput>
<tr>
<td bgcolor = "#bgcolor4#" colspan="#evaluate(listlen(columns)+1+1)#">
...
<td>
	<form action="default.cfm" method="POST">
	<input type="hidden" name="at" value="6">
	<input type="hidden" name="obj" value="006">
