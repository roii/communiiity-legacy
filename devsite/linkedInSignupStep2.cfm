							   ...
							   <form name="signupStep2" id="itc_form_3" method="post" action="/saveandredirect.cfm" onSubmit="return checkform();">
								   ...
								   <input type="hidden" name="ScreenName" value="#ScreenName#" />
									...
									<fieldset class="account-crowdsourcing">
										<h1 class="gray gray-note">#acctinfotext# <i>#allfieldstext#</i></h1>
											        ...
											        <table cellpadding="0" cellspacing="0" border="0" width="100%">
													     <tr>
															  ...
															  <td valign="top" style="padding-left: 12px;">
															       #fullnametext#: &nbsp; #FullName# <br />
																   #profileHeadText#: &nbsp; #headline# <br />
																   #pubprofileurltext#: &nbsp; <a href="#publicProfileUrl#">#clickheretext#</a>
															  </td>
														 </tr>
													</table>   
											   </div> 
										...
										<div class="field user_name require">
										       <div class="field-heading">
											          <label class="big gray" for="user_name">#firstNameText#</label>
										...
										<div class="field user_name require">
										       <div class="field-heading">
											          <label class="big gray" for="user_name">#lastNameText#</label>
													  <span class="field-note"></span>
											   </div>
										...
										<div class="field mail require">
										       <div class="field-heading">
											          <label class="big gray" for="mail">#emailtext1#</label>
													  <span class="field-note"></span>
											   </div>
										...
										<div class="field mail require">
										       <div class="field-heading">
											          <label class="big gray" for="mail">#PasswordText#</label>
													  <span class="field-note"></span>
											   </div>
										...
										<div class="field mail require">
										       <div class="field-heading">
											          <label class="big gray" for="mail">#CpasswordText#</label>
													  <span class="field-note"></span>
											   </div>
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
									     <tr>
										       <td valign="top" width="15%">
											       <input type="submit" value="#signuptext#" class="btn rb">
											   </td>
