...
<div style="float:left; width:100%; margin-top: 20px;"> 
		...
		<div style="float: left; width: 70%;">
			 ...
			 <span style="font-size:20px;">
				 #Wrap(getUserDetails.individual_tagline, 55)#<br />
				 <cfset totalheadlineStr = Len(getUserDetails.individual_tagline)> 
				 <cfif totalheadlineStr eq 130>
				       <cfset FirstSpacePosIn70C = #Find(" ",getUserDetails.individual_tagline,70)#>
					   #FirstSpacePosIn70C#
				 <cfelse>
				    
				 </cfif>
			     <!---<cfset SplitindividualTagline = split(#getUserDetails.individual_tagline#,40)>
