...
<form name="frmSuggestionInputForm" action="#request.webroot#/ideas/act_edit_draft.cfm" method="post">

<input type="hidden" name="SugID" value="#SugID#">
	
<tr>
<td colspan="2"><span style="color:###TRIM(AllSettings.DkTextColor)#;"><strong>UPDATE YOUR DRAFT IDEA</strong></span><br><br>
...
<td valign="top"><input type="text" name="txtareaSuggestion" style="font-size:11px;width:295px;color:###TRIM(AllSettings.BoxColour)#;" maxlength="120" class="whitefield" value="#TRIM(IdeaStuff.Suggestion)#"></td>
</tr>
...
<td valign="top"><input type="submit" value="Update Draft Idea" class="whitefield" onclick="javascript:ValidateAddIdea(frmSuggestionInputForm); return false;"> &nbsp; <input type="button" value="Cancel" class="whitefield" onclick="javascript:history.back(-1);"></td>
</tr>
