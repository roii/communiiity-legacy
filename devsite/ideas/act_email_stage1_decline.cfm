<cfmail server="#application.emailserver#" to="#TRIM(IdeaStuff.emailAddress)#" from="theTeam@my3p.com" subject="Your Idea needs clarification to move to Stage 1" type="HTML">
