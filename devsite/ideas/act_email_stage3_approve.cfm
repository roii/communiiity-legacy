<cfmail server="#application.emailserver#" to="#TRIM(IdeaStuff.emailAddress)#" from="theTeam@my3p.com" subject="Your Idea has made it to Stage 3!" type="HTML">
...
<td>
	...
	<td class="normal"><br>
		...
		You're idea "<strong>#TRIM(IdeaStuff.Suggestion)#</strong>" has made it to <strong>Stage 3</strong>. Congratulations! You've earned an extra <strong>#thisTopic_Points_Stage_3#</strong> points.<br><br>
