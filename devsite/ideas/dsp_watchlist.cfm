			...
			<tr bgcolor="#bgColor#" height="23">
				<td style="padding-left:5px;">
				       <cfif len(suggestion) GT 50>
					       <a title="View Details" href="#request.webroot#/index.cfm?fuseaction=ideas&fusesubaction=docs&documentID=78&ideafunl_mode=WinningDetails&sugID=#sugID#&currentcategory=#this_categoryID#">#suggestion#</a> 
						   <a title="View Details" href="#request.webroot#/index.cfm?fuseaction=ideas&fusesubaction=docs&documentID=78&ideafunl_mode=WinningDetails&sugID=#sugID#&currentcategory=#this_categoryID#" style="color:###TRIM(AllSettings.BoxColour)#;">details..</a>
					   <cfelse>
					       <a title="View Details" href="#request.webroot#/index.cfm?fuseaction=ideas&fusesubaction=docs&documentID=78&ideafunl_mode=WinningDetails&sugID=#sugID#&currentcategory=#this_categoryID#">#suggestion#</a>
					   </cfif>
			    </td>			
				<td align="center">
				      <a href="#request.webroot#/index.cfm?fuseaction=memberprofile&contact=#this_ContactID#" title="View Profile">
					  <cfif TRIM(ContactStuff.ScreenName) NEQ ''>#TRIM(ContactStuff.ScreenName)#<cfelse>#TRIM(ContactStuff.FirstName)#</cfif></a>
				</td>	
				<td align="center">
				      <cfif this_stage NEQ 'Stage 4' AND this_stage NEQ 'Stage 5'>#this_stage#<cfelseif this_stage EQ 'Stage 4'>Doing<cfelse>Done</cfif>
				</td>	
				<td align="center">#this_reward#
				</td>				
				<td align="center">#AllVotes.RecordCount#
				</td>
				<td align="center">#INT(PercentYes)#%
				</td>			
				<td align="center">
				      <cfif IsDefined("isUserVote") AND isUserVote.RecordCount><cfif isUserVote.vote LTE 1>
					      NO
				      <cfelse>
					      YES
					  </cfif>
					  <cfelse><cfif session.UserIsAuthenticated EQ 'Yes' AND this_ContactID NEQ session.userID>&ndash;<cfelseif session.UserIsAuthenticated EQ 'Yes' AND this_ContactID EQ session.userID>Your Idea!<cfelse>&ndash;</cfif></cfif></td>
