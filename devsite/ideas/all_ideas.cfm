...
<cfif qry_all_maincats.recordcount gt 0> 
			...
			<cfset StartCats   = 0> 
															  ...
															  <tr>
																 ...
																 <td valign="top">   
																	<div class="fl badge rounded shadow -ce-capture "> 
																		...
																		<div class="project-details" style="word-wrap: break-word; color: black; height: auto;">   
																			 ...
																			 <div style=" margin-left: 20px; margin-top: 6px;">
																			  ...
																			  <cfif thisTopic_Use_Pending EQ 1>
																				  ...
																				  <a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=75&currentcategory=#this_categoryID#&IdeaFunL_StartRow=1&returnIdeas=#ValueList(AllCat_InActiveIdeas.SugID)#&IdeaFunL_hideIdeas=No&ShowPending=1" style="color:###TRIM(AllSettings.BoxColour)#;"></cfif><strong>#AllCat_InActiveIdeas.RecordCount#</strong> #pendingideas#<cfif session.UserIsAuthenticated AND ListFind(qry_all_categories.Moderators, session.UserID, ",")></a></cfif><br></cfif>
																				  <a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=75&currentcategory=#this_categoryID#&IdeaFunL_StartRow=1&returnIdeas=#ValueList(AllCat_ActiveIdeas.SugID)#&IdeaFunL_hideIdeas=No" style="color:###TRIM(AllSettings.BoxColour)#;"><strong>#AllCat_ActiveIdeas.RecordCount#</strong> #activeideas#</a><br>
																				  <cfif session.UserIsAuthenticated EQ 'Yes'>
																					  <span style="color:###TRIM(AllSettings.BoxColour)#;">
																					   <a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=75&currentcategory=#this_categoryID#&IdeaFunL_StartRow=1&returnIdeas=#ValueList(AllCat_ActiveIdeas.SugID)#&IdeaFunL_hideIdeas=Yes"><strong>#INT(AllCat_ToVoteIdeas.RecordCount - IdeasAlreadyVotedFor.RecordCount)#</strong> #needmyvote#</a><br></span></cfif>				
																																				<a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=75&currentcategory=#this_categoryID#&IdeaFunL_StartRow=1&returnIdeas=#ValueList(AllCat_ReturnedIdeas.SugID)#&IdeaFunL_hideIdeas=No&ShowReturned=1"><strong>#AllCat_ReturnedIdeas.RecordCount#</strong> #retideas#</a><br>
																				  <cfif thisTopic_Use_Stage4 EQ 1><a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=78&srch_category=#this_categoryID#&WinIdeas_StartRow=1&returnIdeas=#ValueList(AllCat_WinnerIdeas.SugID)#"><strong>#AllCat_WinnerIdeas.RecordCount#</strong> #winnerideas#</a><br></cfif>        
																					<cfset thisTotalIdeas = AllCat_ActiveIdeas.RecordCount>        
																					   ...
																					   <cfset thisTotalIdeas = (thisTotalIdeas + AllCat_ReturnedIdeas.RecordCount)>
																							 <strong>
																							  <span style="color:##444444;">#Total#: #INT(thisTotalIdeas)# #ideastxt#</span>
																							 </strong><br>
																			  </div>																	   
																		</div>  
																		<div style="border-top: 1px solid ##808080; margin-top: 5px; padding: 10px;">
						  ...
						  <cfif ctr lte 0 or StartCats lte 0> 
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
									<tr>
										 <td>  
