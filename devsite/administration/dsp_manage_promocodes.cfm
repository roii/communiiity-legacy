...
<td align="center" style="font-size:11px;"><strong>Sign-ups</strong></td>
<td> </td>
</tr>
...
SELECT Count(contactid) AS TotalPromoCount
FROM Contacts
WHERE PromoID=#this_PromoID#
</cfquery>
<tr>
...
<td valign="top" align="center" style="font-size:11px;">#INT(AllMembers.TotalPromoCount)#</td>
<td align="right" valign="top" style="font-size:11px;"><a href="#request.webroot#/administration/dsp_edit_promocode.cfm?PromoID=#this_PromoID#" target="EditPromo" onclick="fdbackwindow=window.open ('','EditPromo','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=550,height=500,top=10,left=10')"><img src="images/but_edit_icon.gif" width="10" height="10" alt="Edit Promo Code" border="0"></a> <a href="javascript:confirmCodeDelete('#request.webroot#/administration/act_delete_promocode.cfm?PromoID=#this_PromoID#');"><img src="images/but_delete_icon.gif" width="10" height="10" alt="Delete Promo Code" border="0"></a></td>
</tr>
