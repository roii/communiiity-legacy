...
<cfelse>
	...
	INSERT INTO Contacts(contactID, contacttypeID, ContactStatus, DateJoined, FirstName, LastName, EmailAddress, EmailConfirmed, Password, receiveEmail, SchoolID)
	VALUES(#newid#, 6, 'Active', #createODBCDateTime(localDateTime)#, '#form.FirstName#', '#form.LastName#', '#form.EmailAddress#', 1, '#form.Profile_Password#', 1, #form.schoolID#)
	</cfquery>
