...
<cfinclude template="../templates/set_language.cfm">
	<title>#TRIM(AllSettings.SiteName)# - #editbusi#</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>#editbusi#</strong></span></td>
</tr>
...
<br>
	...
	<td class="normal" valign="top"><cfinput type="text" required="Yes" message="#bizideaalert#" name="biz_idea" value="#TRIM(Currentbizidea.biz_idea)#" class="whitefield" style="width:300px;"></td>
	</tr>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td Class="normal" valign="top">#disporder#</td>
	<td Class="normal" valign="top"><input type="Radio" name="show" value="1" <cfif Currentbizidea.show EQ '1'>checked</cfif>> #yestitle# &nbsp; <input type="Radio" name="show" value="0" <cfif Currentbizidea.show EQ '0'>checked</cfif>> #notitle#</td>
	</tr>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td Class="small"><br><input type="submit" value="#updatebusinow# >>" class="whitefield"> &nbsp; <input type="button" onClick="javascript:window.close();" value="#cancelbttn# >>" class="whitefield"></td>
	</tr>	
