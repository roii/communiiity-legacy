...
<script type="text/javascript" src="#request.webroot#/administration/colorpicker/jscolor.js"></script>
...
<!--END OF DEEPMETRIX STATSCRIPT--> 
      ...
      <cfinclude template="../templates/header_include.cfm"> 
        ...
        <script src="<cfoutput>#request.webroot#</cfoutput>/js/dataTables.min.js" type="text/javascript"></script>
		<link href="<cfoutput>#request.webroot#</cfoutput>/css/jquery.dataTables.css" rel="stylesheet" type="text/css" />
											...
											<cfelseif fusesubaction EQ 'manage_site_settings'>
												<cfinclude template="dsp_manage_site_settings.cfm">
											...
											<cfelseif fusesubaction EQ 'manage_home_slider_images'>	
												<cfinclude template="dsp_manage_home_slider_images.cfm">
												
											<cfelseif fusesubaction EQ 'add_edit_slider_image'>	
												<cfinclude template="add_edit_slider_image.cfm">
												
											<cfelseif fusesubaction EQ 'delete_slider_image'>	
												<cfinclude template="delete_slider_image.cfm">
												
											<cfelseif fusesubaction EQ 'save_home_slider_image'>	
												<cfinclude template="save_home_slider_image.cfm">				
											...
											<cfelseif fusesubaction EQ 'manage_categories'>	
												<cfinclude template="dsp_manage_categories.cfm">	
											...
											<cfelseif fusesubaction EQ 'manageskills'>
												<cfinclude template="dsp_manage_skills.cfm">
												
											<cfelseif fusesubaction EQ 'dspSkillsAdd'>
												<cfinclude template="dsp_skills_add.cfm">
												
											<cfelseif fusesubaction EQ 'addskillin'>
												<cfinclude template="act_skills_add.cfm">			
											
											<cfelseif fusesubaction EQ 'dspSkillsEdit'>
												<cfinclude template="dsp_skills_edit.cfm">
											
											<cfelseif fusesubaction EQ 'updateskillin'>
												<cfinclude template="act_skills_edit.cfm">
												
											<cfelseif fusesubaction EQ 'DeleteSkills'>
												<cfinclude template="act_skills_delete.cfm">			
