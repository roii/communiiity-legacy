...
<cfif IsDefined("FORM.siteWidthSize") and FORM.siteWidthSize neq ''>
      <cfset siteWidthSize = FORM.siteWidthSize>
<cfelse>
      <cfset siteWidthSize = "">
</cfif>

<cfif IsDefined("FORM.siteBttnColor") and FORM.siteBttnColor neq ''>
      <cfset siteBttnColor = FORM.siteBttnColor>
<cfelse>
      <cfset siteBttnColor = "">
</cfif>

<cfif IsDefined("FORM.siteBackGColor") and FORM.siteBackGColor neq ''>
      <cfset siteBackGColor = FORM.siteBackGColor>
<cfelse>
      <cfset siteBackGColor = "">
</cfif>
  
 <cfquery name="updateSizeWidth" datasource="#dsn#" username="#request.username#" password="#request.password#">
      UPDATE settings SET siteWidthSize = '#siteWidthSize#', siteBttnColor = '#siteBttnColor#', siteBackGColor = '#siteBackGColor#' WHERE ParserURL LIKE '%#cgi.http_host#%'
 </cfquery>
 
 <cflocation url="/index.cfm?fuseaction=#URL.fuseaction#&fusesubaction=#URL.fusesubaction#&suc=1" addtoken="no">
