...
<html>
<head>
<title>#TRIM(AllSettings.SiteName)# - Add Testimonial</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add Testimonial</strong></span></td>
</tr>
...
<br>
	...
	<option value="#allkids.contactID#">#TRIM(AllKids.FirstName)# #TRIM(AllKids.LastName)#
	</cfloop>
	</select></td>
	</tr>
	...
	<td><input type="radio" name="Testimonial_sidebar" class="whitefield" value="1"> Yes &nbsp; <input type="radio" name="Testimonial_sidebar" class="whitefield" value="0" checked> No</td>
	</tr>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td><input type="submit" value="ADD TESTIMONIAL NOW >>" class="whitefield"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
