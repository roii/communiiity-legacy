...
<br>	
	...
	<form name="AddTopic" action="#request.webroot#/administration/act_add_ideafunl_topic.cfm" method="post" onSubmit="javascript:validate(AddTopic); return false;" enctype="multipart/form-data">
