...
<cfif uploadFileError EQ 'false'>
	...
	<!---<cfimage action="resize" file="#request.fileroot#\images\goals\#image_upload_name#" output="#request.fileroot#\images\goals\thumb_#image_upload_name#" quality="100" x="80" y="60">--->
	
	<cfimage source="#request.fileroot#\images\goals\#image_upload_name#" action="resize" width="80" height="60" destination="#request.fileroot#\images\goals\thumb_#image_upload_name#" overwrite="yes">
