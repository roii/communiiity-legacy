<%@ Page Language="c#" Inherits="SqlWebAdmin.DeleteDatabaseRole" CodeFile="DeleteDatabaseRole.aspx.cs" %>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="databaseListItem">
                                                        Are you sure you want to delete the database role
                                                        <asp:Label ID="RoleName" runat="server" />?
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="databaseListItem" align="right">
                                                        <asp:Button Text="Yes" OnClick="Yes_Click" runat="server" />
                                                        &nbsp;
                                                        <asp:Button Text="No" OnClick="No_Click" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
