<%@ Reference Control="~/LoginRolePicker.ascx" %>

<%@ Page Language="c#" Inherits="SqlWebAdmin.CreateDatabaseRole" CodeFile="CreateDatabaseRole.aspx.cs" %>
                                    ...
                                    <td bgcolor="white" class="databaseListItem">
                                        <table border="0" cellspacing="0" cellpadding="0" width="400">
                                            ...
                                            <tr>
                                                ...
                                                <td class="databaseListItem">
                                                    SQL Server supports two types of database roles: standard roles, which contain members,
                                                    and database roles, which require a password.
                                                    <br />
                                            ...
                                            <tr>
                                                <td colspan="2" align="right" class="databaseListItem">
                                                    <asp:Button Text="Create Role" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
