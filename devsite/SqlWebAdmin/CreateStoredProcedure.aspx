                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td bgcolor="white" class="databaseListItem">
                                            ...
                                            <asp:Button ID="CreateNewSProcButton" runat="server" CssClass="button" onMouseOver="this.style.color='#808080';"
                                                onMouseOut="this.style.color='#000000';" Text="Create" OnClick="CreateNewSProcButton_Click">
                                            </asp:Button>
                                            <br>
                                            <br>
                                            <asp:RequiredFieldValidator runat="server" ID="SProcNameRequiredValidator" ControlToValidate="SProcNameTextBox"
                                                Display="Dynamic" ErrorMessage="The stored procedure name cannot be empty."></asp:RequiredFieldValidator>
