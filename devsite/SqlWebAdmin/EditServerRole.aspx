<%@ Page Language="c#" Inherits="SqlWebAdmin.EditServerRole" CodeFile="EditServerRole.aspx.cs" %>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
                                        <td bgcolor="white" class="databaseListItem">
                                            Select which logins are assigned to this role:<br />
                                            <br />
                                    ...
                                    <tr>
                                        <td class="databaseListItem" align="right">
                                            <input type="button" value="Done" onclick="location.href='ServerRoles.aspx'" />
                                        </td>
                                    </tr>
                                    <tr>
