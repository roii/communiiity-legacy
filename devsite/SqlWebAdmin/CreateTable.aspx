...
<%@ Page Language="c#" Inherits="SqlWebAdmin.CreateTable" CodeFile="CreateTable.aspx.cs" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Web Data Administrator - Create Table</title>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td bgcolor="white" class="databaseListItem">
                                            ...
                                            <br>
                                            <br>
                                            <asp:TextBox ID="TableNameTextBox" runat="server" Columns="30"></asp:TextBox>&nbsp;
                                            <asp:Button ID="CreateNewTableButton" runat="server" CssClass="button" onMouseOver="this.style.color='#808080';"
                                                onMouseOut="this.style.color='#000000';" Text="Create" OnClick="CreateNewTableButton_Click">
                                            </asp:Button>
                                            <br>
                                            <br>
