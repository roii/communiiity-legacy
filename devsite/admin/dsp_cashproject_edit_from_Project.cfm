...
<br>
	...
	<form method="post" action="#request.webroot#/admin/act_cashproject_edit_from_Project.cfm" name="addform" enctype="multipart/form-data" onSubmit="javascript:validate(addform); return false;">
	...
	<td Class="normal" valign="top">
	<p> 
			<textarea cols="80" id="details" name="details" rows="20" cols="60">#TRIM(ProjectDetails.details)#</textarea>
			<script> 
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td Class="small"><br><input type="submit" onClick="javascript:ae_onSubmit(); validate(addform); return false;" value="#updatecashbttn# >>" class="whitefield"> &nbsp; <input type="button" onClick="javascript:window.close();" value="#cancelbttn# >>" class="whitefield"></td>
	</tr>	
