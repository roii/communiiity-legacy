...
<html>
<head>
	<title>MyKidsBiz - Edit News Category</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Edit a News Category</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_newscat_edit.cfm">
	<input type="hidden" name="NewsCatID" value="#NewsCatID#">
	...
	<td class="normal" valign="top"><input name="NewsCatName" class="whitefield" size="85" value="#CatDetails.NewsCatName#"></td>
	</tr>
	...
	<td class="normal" valign="top"><input name="NewsCatOrder" class="whitefield" size="85" value="#CatDetails.NewsCatOrder#"></td>
	</tr>
