...
<br>
	...
	<form method="post" action="#request.webroot#/admin/act_cashproject_edit.cfm" name="addform" enctype="multipart/form-data">
	...
	<td class="normal" valign="top">
			...
			<strong style="color: blue;"><br>Note: * Please upload only 200x200 size image. <br>If you have already uploaded the image and want to update it or you didn't upload earlier then you can use this option.</strong> 
	</td>
	</tr>
