...
<html>
<head>
	<title>MyKidsBiz - Edit Event Category</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Edit this Event Category</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_eventcat_edit.cfm">
	<input type="hidden" name="EventCatID" value="#EventCatID#">
	<input type="hidden" name="fuseaction" value="#TRIM(fuseaction)#">
	...
	<td class="normal" valign="top"><input name="EventCatName" class="whitefield" size="85" value="#CatDetails.EventCatName#"></td>
	</tr>
