...
<br>
	...
	<tr>
		<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
		<td class="normal" valign="top" width="110">Gallery Images</td>
		<td class="normal" valign="top">
				<input type="file" name="gallery_pics_1" id="gallery_pics_1" value="" />
				<strong style="color: blue;">Note: * Please upload only 700x306 size image.</strong> <br>
				...
				<strong style="color: blue;">Note: * Please upload only 700x306 size image.</strong>
		</td>
	</tr>
