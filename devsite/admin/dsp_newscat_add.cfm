...
SELECT NewsCatOrder
FROM NewsCategories
ORDER BY NewsCatOrder DESC
</cfquery>

<cfif #LastOrder.RecordCount# GT 0>
	<cfset nextOrder=(#LastOrder.NewsCatOrder# + 1)>
<cfelse>
	<cfset nextOrder=1>
</cfif>
...
<html>
<head>
	<title>MyKidsBiz - Add News Category</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add a News Category</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_newscat_add.cfm">
	...
	<td class="normal" valign="top"><input name="NewsCatName" class="whitefield" size="85"></td>
	</tr>
	...
	<td class="normal" valign="top"><input name="NewsCatOrder" class="whitefield" size="85" value="#NextOrder#"></td>
	</tr>
