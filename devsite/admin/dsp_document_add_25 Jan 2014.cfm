...
<html>
<head>
	<title>#TRIM(AllSettings.SiteName)# - Add Level 2 Document</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add Level 2 Document</strong></span></td>
</tr>
...
<br>
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td class="normal" width="120">Plugin Module</td>
	<td><select name="module" class="whitefield">
	<option value="none" checked> NONE
	<option value="News"> News Releases
	<option value="Events"> Events Calendar
	<option value="Links"> Related Links
	</select></td>
	</tr>
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td class="normal" valign="top" width="110">Document Title</td>
	...
	<td><input type="radio" Class="whitefield" name="HomePromote" value="1" checked> Yes &nbsp;&nbsp;&nbsp;<input type="radio" Class="whitefield" name="HomePromote" value="0"> No</td>
	</tr>	
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td Class="small"><br><input type="submit" onclick="javascript:ae_onSubmit(); validate(addform); return false;" value="ADD DOCUMENT NOW >>" class="whitefield"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>	
