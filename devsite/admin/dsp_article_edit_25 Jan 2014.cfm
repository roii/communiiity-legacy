...
<html>
<head>
	<title>#TRIM(AllSettings.SiteName)# - Edit Level 3 Document</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Edit Level 3 Document</strong></span></td>
</tr>
...
<br>
	...
	<td Class="normal" valign="top"><input type="radio" Class="whitefield" name="Released" value="1"<cfif #articleStuff.Released# EQ 1> checked</cfif>> Yes &nbsp;&nbsp;&nbsp;<input type="radio" Class="whitefield" name="Released" value="0"<cfif #articleStuff.Released# EQ 0> checked</cfif>> No</td>
	</tr>		
