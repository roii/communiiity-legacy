...
<script type="text/javascript" src="/admin/CalendarPopup.js"></script>
...
<cfinclude template="../templates/styles.cfm">
	...
	<title>#TRIM(AllSettings.SiteName)# - #editlevel32doc#</title>
</head>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>#editlevel32doc#</strong></span></td>
</tr>
...
<br>
	...
	<input type="text" name="PubDate" class="whitefield" size="68" style="width:300px;" readonly="readonly" value="#dateformat(DocumentDetails.PubDate, "d mmmm yyyy")#">
<a id="anchor1" name="anchor1" title="Select Published Date" onClick="cal1.select(document.forms[0].PubDate,'anchor1','dd MMM yyyy'); return false;" href="##" style="text-decoration: none; color: black;">#Calendar# >></a>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td>#expiryDate#</td>
	<td><input type="text" Class="whitefield" size="68" name="DocExpireDate" readonly="readonly" value="#dateformat(DocumentDetails.DocExpireDate, "d mmmm yyyy")#"> &nbsp; 
	
	<a id="anchor1" name="anchor1" title="Select Expiry Date" onClick="cal1.select(document.forms[0].DocExpireDate,'anchor1','dd MMM yyyy'); return false;" href="##" style="text-decoration: none; color: black;">#Calendar# >></a>
	<!---<a href="#request.webroot#/templates/dsp_pop_calendar.cfm?Field=DocExpireDate&formName=editform&Enc=No" target="popcalendar" ONCLICK="fdbackwindow=window.open ('','popcalendar','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0,width=160,height=140,top=50,left=50')" style="color:black; text-decoration:none;">Calendar >></a>--->
	</td>
	</tr>		
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td>#released#</td>
	<td><input type="radio" Class="whitefield" name="Released" value="1"<cfif #DocumentDetails.Released# EQ 1> checked</cfif>> #yestitle# &nbsp;&nbsp;&nbsp;<input type="radio" Class="whitefield" name="Released" value="0"<cfif #DocumentDetails.Released# EQ 0> checked</cfif>> #notitle#</td>
	</tr>		
	...
	<td><input type="radio" Class="whitefield" name="HomePromote" value="1"<cfif DocumentDetails.HomePromote EQ 1> checked</cfif>> #yestitle# &nbsp;&nbsp;&nbsp;<input type="radio" Class="whitefield" name="HomePromote" value="0"<cfif DocumentDetails.HomePromote EQ 0> checked</cfif>> #notitle#</td>
	</tr>	
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td width="120" valign="top">#announcedbox#</td>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td><br><input type="submit" onClick="javascript:ae_onSubmit(); validate(editform); return false;" value="#updatedocnow# >>" class="whitefield"> &nbsp; <input type="button" onClick="javascript:window.close();" value="#cancelbttn# >>" class="whitefield"></td>
	</tr>	
