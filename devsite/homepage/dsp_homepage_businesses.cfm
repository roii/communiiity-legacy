...
<tr>
<td bgcolor="###AllSettings.BoxColour#" style="color:###TRIM(AllSettings.BoxTextColour)#;font-size:12px;padding-left:5px;" height="20" colspan="3"><strong>Businesses - Top 3</strong></td>
</tr>
...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="2" border="0"><br>
	...
	<tr>
	<td style="color:Black; font-size:12px; padding-left:5px;">By: &nbsp;<a href="##" onClick="javascript:BizSwapView('1', 0);" style="color:black;text-decoration:none;font-weight:bold;" id="BY1">Profit per hour</a> | <a href="##" onClick="javascript:BizSwapView('2', 0);" style="color:black;text-decoration:none;font-weight:normal;" id="BY2">Popularity</a></td>
	</tr>
	...
	<div id="TBL2" style="position:absolute; border-style:none; Z-INDEX: TBL; visibility:hidden;">
		...
		<td style="color:Black;font-size:12px;padding-right:5px;" width="100%">#toppopularbiz.total#</td>
		</tr>
