...
<cfif IsNumeric("#totalProfit#") AND totalProfit GT 0 AND IsNumeric("#TotalHours#") AND TotalHours GT 0>
...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="2" border="0"><br>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Businesses:</td>
