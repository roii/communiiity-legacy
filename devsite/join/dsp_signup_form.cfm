...
<h2 class="form-signin-heading"> #ReReplace(registerheadingtext, "\b(\w)", "\u\1", "ALL")# </h2>

<form name="kidsReg" action="#request.webroot#/join/act_signup.cfm" method="post" name="PageRegisterForm" class="form-signin" role="form">
 
   <input type="text" class="form-control" placeholder="Email address" name="EmailAddress" value="" autofocus>
   <br />
   <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="validate(kidsReg); return false;">Register Now</button> 
   <br />#ortext# <br>
