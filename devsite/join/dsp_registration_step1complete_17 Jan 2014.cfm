...
<tr>
<td width="100%" style="font-size:12px;color:###TRIM(AllSettings.DkTextColor)#" height="20"><strong>THANKS!</strong></td>
...
<tr>
	...
	<span style="padding-left:20px;color:###TRIM(AllSettings.DkTextColor)#;"><strong>Check your email: <strong>#TRIM(ContactDetails.EmailAddress)#</strong> for your verification link.</strong></span><br><br>
</td>
	</tr>
</form>
