...
<tr>
<td width="100%" style="font-size:12px;color:###TRIM(AllSettings.DkTextColor)#" height="20"><strong>VERIFICATION COMPLETE!</strong></td>
...
<tr>
<td colspan="2"><span style="color:###TRIM(AllSettings.DkTextColor)#"><strong>Final Step before you join the community and start profiting!</strong></span><br><br>
<ol>
<li>Enter your details in the form below. (All fields are required)</li>
...
<br><br>
	...
	<td>	
		...
		<td>		
			...
			First Name <span style="color:###TRIM(AllSettings.BoxColour)#;"><strong>*</strong></span></td>
			<td><input type="text" name="FirstName" class="whitefield" style="width:250px;" value=""></td>
			</tr>
			
			<tr>
			<td style="color:###TRIM(AllSettings.DkTextColor)#;">
			Last Name <span style="color:###TRIM(AllSettings.BoxColour)#;"><strong>*</strong></span></td>
			...
			<tr>
			<td style="color:###TRIM(AllSettings.DkTextColor)#;">Country <span style="color:###TRIM(AllSettings.BoxColour)#;"><strong>*</strong></span></td>
			...
			<td style="color:###TRIM(AllSettings.DkTextColor)#;">Password <span style="color:###TRIM(AllSettings.BoxColour)#;"><strong>*</strong></span></td>
			<td><input type="password" name="Password" class="whitefield" style="width:250px;"></td>
			</tr>
			
			<td style="color:###TRIM(AllSettings.DkTextColor)#;">Confirm Password <span style="color:###TRIM(AllSettings.BoxColour)#;"><strong>*</strong></span></td>
			...
			<tr>
			<td style="color:###TRIM(AllSettings.DkTextColor)#;" valign="top">Accept Terms</td>
			<td valign="top">
				...
				<td style="padding-left:4px;" valign="top">I HAVE READ AND ACCEPT THE<br>
				<a href="#request.webroot#/index.cfm?fuseaction=terms">TERMS OF USE AGREEMENT</a>. I AGREE TO ALL OF THE PROVISIONS CONTAINED WITHIN IT.</td>
				</tr>
