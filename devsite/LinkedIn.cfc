...
<cfcomponent displayname="LinkedIn.cfc" hint="Functions to interact with LinkedIn API" output="yes">	
	<cfscript>
		variables.callback = "http://www.crowdsourciiing.com/CallBack.cfm"; // SET THIS TO THE FULL URL OF YOUR CALLBACK  
		variables.apiKey = "75ova4anubqvza";
		variables.secretKey = "9Jp0U5eiOj74qFcf";		
		//DO NOT CHANGE THESE
	...
	<cffunction name="getProfiles" access="public" output="no" returntype="any">
		...
		<cfset result = doLinkedInCommand(arguments.authToken, arguments.authTokenSecret, "http://api.linkedin.com/v1/people/#arguments.identifier#:(id,first-name,last-name,email-address,headline,picture-url,public-profile-url)", "GET") />
