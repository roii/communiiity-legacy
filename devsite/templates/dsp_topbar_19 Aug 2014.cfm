...
<link rel="stylesheet" type="text/css" href="/devsite/css/myCS.css">
<cfoutput>
					  ...
					  <div class="containerNav">
						...
						<div class="navbar-collapse collapse"> 
						  <ul class="nav navbar-nav navbar-right"> 
							<li><cfif fusesubaction NEQ 'step2'> 
							  ...
							  <cfloop query="basenav">
									...
									<cfelse>
										   <a href="#request.webroot#/index.cfm?fuseaction=#TRIM(basenav.fuseaction)#" style="color:##FFFFFF;font-family:Verdana, Geneva, sans-serif;font-size:small; text-decoration: none;">
											      <cfif IsDefined("Session.defaultlang") and Session.defaultlang neq ''>
													       <cfif Session.defaultlang eq 'fr'>
														         #MenuFrenchTitle#
														   <cfelse>
							...
							<cfelse>
								<li>
									 <a href="#request.webroot#/index.cfm?fuseaction=join" style="color:##FFFFFF; font-family: Verdana,Geneva,sans-serif; font-size: small; text-decoration: none;">#register#</a>  
								</li>  
							</cfif>	 
						  </ul>
						</div><!--/.nav-collapse -->
