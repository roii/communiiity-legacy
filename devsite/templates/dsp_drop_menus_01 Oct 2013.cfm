											 ...
											 <td valign="top"> 
												...
												<cfelse>
												      ...
												      <cfelseif #getProfilePic.profilepic# neq ''>
													        <img border="0" src="/images/profiles/small_#getProfilePic.profilepic#" style="width: 21px; color:##FFFFFF;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">
													  <cfelse>
										...
										<cfelse>
										     <td>
											          ...
											          <cfelseif #getProfilePic.profilepic# neq ''>
													        <img border="0" src="/images/profiles/small_#getProfilePic.profilepic#" style="width: 21px; color:##FFFFFF;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">
													  <cfelse>
													       <cfif #getProfilePic.linkedinuser# eq 1 and #getProfilePic.linkedinprofilepic# neq ''>
														         <img border="0" src="#getProfilePic.linkedinprofilepic#" style="width: 21px; color:##FFFFFF;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">	
														   <cfelse>
														         <img border="0" src="/images/default_avatar.gif" style="width: 21px; color:##FFFFFF;" alt="No Image" title="No Image">				 	
														   </cfif>  
													  </cfif> 
			 ...
			 <div class="dropdown">
				...
				<div class="submenu" style="display: none; width: 204px;"> 
					 <ul class="root">
							 ...
							 <li>
								  <a href="#request.webroot#/index.cfm?fuseaction=administration&fusesubaction=manage_site_settings">Site Settings</a>
							 </li>
