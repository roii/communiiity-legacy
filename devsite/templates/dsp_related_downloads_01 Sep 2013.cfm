<cfif (librarylinks.recordcount) OR (session.UserIsAuthenticated EQ 'yes') AND (session.UserType EQ 'Administrator')>
...
<td bgcolor="###TRIM(AllSettings.BoxColour)#">
	...
	<tr>
	<td height="22" style="color:###TRIM(AllSettings.BoxTextColour)#;font-face:Trebuchet MS;font-size:12px;">&nbsp;<b>R E L A T E D &nbsp; R E S O U R C E S</b></td>
	</tr>
...
<td>
	...
	<td align="center" width="60" style="color:white;">File Size</td>
	<cfif (session.UserIsAuthenticated EQ 'yes') AND (session.UserType EQ 'Administrator')>
	<td width="20"> </td>
	</cfif>
	</tr>
