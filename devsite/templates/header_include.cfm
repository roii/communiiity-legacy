...
<![endif]--><!---<cfset strVersion = SERVER.ColdFusion.ProductVersion />
 <cfoutput>
    #strVersion#
 </cfoutput><cfabort>--->
						...
						<div class="bs-container"> 
							   <cfset start = 1>
										<cfoutput query="getSliderImages">	
											<!-- Bootslider Slide  image_url  image_text  -->
									        <cfif image_url neq '' or (image_url neq '' and image_text neq '')>		
															<cfif start eq 1> 
																 <div class="bs-slide active" data-animate-in="bounceInUp" data-animate-out="hinge" onclick="javascript: window.location = '#image_url#';" style="cursor: pointer;">
															<cfelse>	 
																 <div class="bs-slide" data-animate-in="bounceInUp" data-animate-out="hinge" onclick="javascript: window.location = '#image_url#';" style="cursor: pointer;">
															</cfif>	 
															...
															<div class="bs-background">  
																  <img src="#request.webroot#/images/homePageSliderImages/#image_name#" alt="" border="0" />  
															</div>
															</div>
											</cfif>			 
											<!-- /Bootslider Slide --> 
