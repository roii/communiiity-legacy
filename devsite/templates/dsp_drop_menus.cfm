...
<cfif fusesubaction NEQ 'step2'> 
		...
		<cfset thisfuseaction = TRIM(mainmenu.fuseaction)> 
		  ...
		  <cfelse>
			   <cfset menutitle2Disp = #TRIM(mainmenu.MenuFrenchTitle)#>
				...
				<li>
					<a href="#request.webroot#/index.cfm?fuseaction=#thisfuseaction#" style="text-decoration: none; width: 100%;"><span style="color:<cfif TRIM(thisfuseaction) EQ attributes.fuseaction>black<cfelse>black</cfif>;font-family:Trebuchet MS;font-size:12px;text-decoration:none;"><strong>#menutitle2Disp#</strong></span></a>
				</li>
		</cfloop>
</cfif> 
 <li class="dropdown">
		<cfif session.UserIsAuthenticated EQ 'Yes' AND session.UserType NEQ 'Administrator'>
			 ...
			 <cfelse>
											...
											<cfif pictureUrl neq ''>
												 <td valign="top"> 
													<cfif #session.pictureUrl# eq 0 and #profilePic# eq ''>
														 <img border="0" src="/images/default_avatar.gif" style="width: 21px; color:black;" alt="No Image" title="No Image">
													<cfelse>
														  <cfif #filename# neq ''>
																<img border="0" src="/images/profiles/small_#filename#" style="width: 21px; color:black;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">
														  <cfelseif #profilePic# neq ''>
																<img border="0" src="/images/profiles/small_#profilePic#" style="width: 21px; color:black;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">
														  <cfelse>
																 <cfif #session.pictureUrl# eq 0 and #session.pictureUrl# eq '0'>
																	  <img border="0" src="/images/default_avatar.gif" style="width: 21px; color:black;" alt="No Image" title="No Image">
																 <cfelse>
																	  <img border="0" src="#session.pictureUrl#" style="width: 21px; color:black;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">	
																 </cfif>	  	
														  </cfif> 
													</cfif> 
												 </td>
														  ...
														  <cfelse>
															   <cfif #linkedinuser# eq 1 and #linkedinprofilepic# neq ''> 
																	 <cfif #linkedinprofilepic# eq 0 and #linkedinprofilepic# eq '0'>
																		  <img border="0" src="/images/default_avatar.gif" style="width: 21px; color:black;" alt="No Image" title="No Image">
																	 <cfelse>
																		  <img border="0" src="#linkedinprofilepic#" style="width: 21px; color:black;" alt="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#" title="#ReReplace(session.User_FirstName,'\b(\w)','\u\1','ALL')# #ReReplace(session.User_LastName,'\b(\w)','\u\1','ALL')#">
																	 </cfif> 
															   <cfelse>
																	 <img border="0" src="/images/default_avatar.gif" style="width: 21px; color:black;" alt="No Image" title="No Image">				 	
															   </cfif>  
			    ...
			    <ul class="dropdown-menu" role="menu">
			                <!---<li>
							 ...
							 <li>
								  <a href="#request.webroot#/index.cfm?fuseaction=myprojects">#myprojects#</a>
							 </li>
							 <li>
								  <a href="#request.webroot#/index.cfm?fuseaction=followedproj">#followedproj#</a>
							 </li>
							 <li>
							      <a href="#request.webroot#/index.cfm?fuseaction=updateprofile&fusesubaction=index##tabs1-settings">My Settings</a>
							 </li>
							 <li>
								  <a href="#request.webroot#/user/profile/#SESSION.userid#">My Profile</a>
							 </li>
							<!--- <li>
		 ...
		 <script language="javascript">
		     function changeColor(anchorID) {
			      var color = $('##anchorID').css('color'); 
				      if(color == 'black')
					  {    
					        $('##anchorID').css('color', 'white');
					  }
					  else
					  {     
					        $('##anchorID').css('color', 'black');
					  } 
			 }
		 </script>
		<cfif session.UserIsAuthenticated EQ 'Yes' AND session.UserType EQ 'Administrator'>
		     <!---caret--->
			    <a id="adminSEcID" href="##" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; width: 100%;" onclick="changeColor('adminSEcID');">
						 <span style="color:<cfif TRIM(thisfuseaction) EQ attributes.fuseaction>black<cfelse>black</cfif>;font-family:Trebuchet MS;font-size:12px;text-decoration:none;"><strong>
							   ADMIN 
						 </strong></span> 
				</a>
		        <ul class="dropdown-menu" role="menu">
							 ...
							 <li>
								  <a href="#request.webroot#/index.cfm?fuseaction=administration&fusesubaction=manageskills">Manage Skills</a>
							 </li>
							 <li>
 ...
 <cfif session.UserIsAuthenticated EQ 'Yes' AND session.UserType EQ 'Administrator'>
	 <li class="dropdown">
					<a href="##" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; width:100%">
							 <span style="color:<cfif TRIM(thisfuseaction) EQ attributes.fuseaction>black<cfelse>black</cfif>;font-family:Trebuchet MS;font-size:12px;text-decoration:none;"><strong>
								   SECTIONS
							 </strong></span>
					</a>
					<ul class="dropdown-menu" role="menu">   
					             <li>
									   <a href="#request.webroot#/index.cfm?fuseaction=administration&fusesubaction=manage_home_slider_images">
										 Manage Home Slider Images</a>
								 </li>
							  <cfif session.permission1_view EQ 1>
								 <li>
