		...
		<cfset thisfuseaction = TRIM(mainmenu.fuseaction)> 
		  ...
		  <cfelse>
			   <cfset menutitle2Disp = #TRIM(mainmenu.MenuFrenchTitle)#>
				...
				<li>
					<a href="#request.webroot#/index.cfm?fuseaction=#thisfuseaction#" style="text-decoration: none; width: 100%;"><span style="color:<cfif TRIM(thisfuseaction) EQ attributes.fuseaction>##FFFFFF<cfelse>##FFFFFF</cfif>;font-family:Trebuchet MS;font-size:12px;text-decoration:none;"><strong>#menutitle2Disp#</strong></span></a>
				</li>
		</cfloop>
</cfif> 
 <li class="dropdown">
		...
		<cfif session.UserIsAuthenticated EQ 'Yes' AND session.UserType EQ 'Administrator'>
		     <!---caret--->
			    <a id="adminSEcID" href="##" class="dropdown-toggle" data-toggle="dropdown" style="text-decoration: none; width: 100%;" onclick="changeColor('adminSEcID');">
						 <span style="color:<cfif TRIM(thisfuseaction) EQ attributes.fuseaction>##FFFFFF<cfelse>##FFFFFF</cfif>;font-family:Trebuchet MS;font-size:12px;text-decoration:none;"><strong>
							   ADMIN 
						 </strong></span> 
				</a>
		        <ul class="dropdown-menu" role="menu">
