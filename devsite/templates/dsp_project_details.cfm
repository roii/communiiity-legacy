...
<td>
	...
	<cfif TRIM(projectdetails.CreditsOffered) NEQ ''>
		<cfif projectdetails.paymenttype contains 'money'>#TRIM(projectDetails.PaidIn)##DecimalFormat(projectdetails.CreditsOffered)#
		<cfelse>#INT(projectdetails.CreditsOffered)# pts</cfif><cfelse>&ndash;</cfif></td>
