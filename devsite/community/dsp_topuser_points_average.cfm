...
<td>
	...
	<cfif IsDefined("showgraph") and showgraph EQ 1>
		...
		<tr>
		<td colspan="5" style="color:Black;"><strong>TOP 10 USERS - Average Points Per Month</strong></td>
		</tr>
		...
		<cfchart format="flash" chartHeight="200" chartWidth="700" showxgridlines="yes" showygridlines="yes" showborder="yes" font="Arial" fontsize="10" fontbold="no" fontitalic="no" show3d="no" rotated="no" sortxaxis="no" showlegend="no" showmarkers="no" style="my3p_stats.xml">
			...
			<cfchartseries type="bar" seriescolor="##0066CC">
				...
				<cfloop query="qry_top_users" startrow="1" endrow="10">
					...
					<cfchartData item="#this_Name#" value="#this_average#">
				</cfloop>
	...
	<tr>
	<td><img src="#request.imageroot#/transparent_spc.gif" width="20" height="10" border="0"></td>
	<td><img src="#request.imageroot#/transparent_spc.gif" width="150" height="10" border="0"></td>
	<td><img src="#request.imageroot#/transparent_spc.gif" width="90" height="10" border="0"></td>
	<td><img src="#request.imageroot#/transparent_spc.gif" width="90" height="10" border="0"></td>
	<td><img src="#request.imageroot#/transparent_spc.gif" width="90" height="10" border="0"></td>
	</tr>
	...
	<tr>
	<td colspan="5" style="color:Black;"><strong>TOP 100 USERS - Average Points Per Month</strong></td>
	</tr>
	...
	<td><a href="#request.webroot#/index.cfm?fuseaction=memberprofile&contact=#this_ContactID#"><img src="#request.imageroot#/icons/people_tiny.gif" width="15" height="12" border="0" align="absmiddle" title="View Profile"></a>&nbsp;&nbsp;<a href="#request.webroot#/index.cfm?fuseaction=memberprofile&contact=#TRIM(this_ContactID)#" style="color:###TRIM(session.AllSettings_BoxColour)#;" title="View Profile"><strong><cfif TRIM(qry_contact_stuff.ScreenName) NEQ ''>#TRIM(qry_contact_stuff.ScreenName)#<cfelse>#TRIM(qry_contact_stuff.FirstName)#</cfif></strong></a></td>
