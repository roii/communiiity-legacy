...
<cfparam name="statsmode" default="0">
<cfoutput>
...
<cfif attributes.fusesubaction EQ 'index'>
	...
	<cfelse>
		...
		<cflocation url="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=100">
...
<cfelseif attributes.fusesubaction EQ 'docs'>
	...
	<cfelse>
		...
		<cfif attributes.documentID EQ 102>
		
			<cfparam name="partnermode" default="list">
			
			<cfif partnermode EQ 'list'>
				<cfinclude template="../templates/dsp_document_details.cfm">
				<cfinclude template="dsp_partner_list.cfm">
			<cfelse>
				<cfif IsDefined("organisationID")>
					<cfinclude template="dsp_partner_profile.cfm">
				<cfelse>
					<cflocation url="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=#fusesubaction#&documentID=#documentID#&partnermode=list">
				</cfif>			
			</cfif>
		
		
		<cfelseif attributes.documentID EQ 109>
		
			<cfinclude template="../templates/dsp_document_details.cfm">
			<cfinclude template="dsp_testimonials.cfm">
			
		<cfelseif attributes.documentID EQ 116>
