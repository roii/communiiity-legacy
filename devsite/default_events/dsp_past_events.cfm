...
<table border="0" cellpadding="0" cellspacing="2" width="100%">
 <cfoutput>		
<tr>
<td class="page_header" width="100%"><a href="#request.webroot#/index.cfm?fuseaction=#TRIM(sectiondetails.fuseaction)#" style="text-decoration:none; color:black;"><cfif #session.textonly# EQ 'yes'>#SectionDetails.Title#<cfelse><img src="#request.imageroot#/title_#TRIM(sectiondetails.fuseaction)#.gif" border="0"></cfif></a></td>
...
<tr>
<td class="page_header" width="100%">#UCASE(DocumentDetails.Title)# - Archives</td>
...
<td><br>
	...
	<cfset eventsFound='no'>
	
	<cfoutput query="EventsReturn" group="EventCatID">

	<cfinclude template="../default_events/qry_past_events.cfm">

	<cfif #EventDetails.recordcount# GT 0>
	
	<cfset eventsFound='yes'>
...
<cfif #eventsFound# EQ 'Yes'>
<cfoutput><br><img src="#request.imageroot#/transparent_spc.gif" width="5" height="6"  border="0"></cfoutput><br>
...
<td <cfif #session.textonly# EQ 'yes'>bgcolor="black"<cfelse>bgcolor="#TRIM(sectionDetails.barColor)#"</cfif>>
	...
	<td><span class="small" style="letter-spacing:.2em; color:white;"><b>#UCASE(EventCatName)#</b></span></td>
	</tr>
...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="12" border="0"><br>
	...
	<cfif #TRIM(EventDetails.Venue)# NEQ ''>&nbsp;#TRIM(EventDetails.Venue)#<br></cfif>
	&nbsp;<a href="#request.webroot#/default_events/dsp_pastevent_details.cfm?EventID=#EventID#" target="feedback" ONCLICK="fdbackwindow=window.open ('','feedback','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=550,height=500,top=10,left=10')"><strong>#EventDetails.EventTitle#</strong></a><cfif #EventDetails.PastEventReport# EQ 1><br>
	&nbsp;<a href="#request.webroot#/default_events/dsp_pastevent_details.cfm?EventID=#EventID#" target="feedback" ONCLICK="fdbackwindow=window.open ('','feedback','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=550,height=500,top=10,left=10')" style="color:gray; text-decoration:none;"><b>Read event summary >></b></a></cfif></span><br><br>
	</td>
	<cfif (#session.UserIsAuthenticated# EQ 'yes') AND (#session.UserType# EQ 'Administrator')>
...
<strong><em>There are currently no archived events.</em></strong>
</cfif>
