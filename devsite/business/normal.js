...
var gcCalBG="#FD7922";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#99CC00";	// the background color of the inner table, showing as a frame.
...
var gsNavPrev="<INPUT id='navPrev' type='button' value='&lt;' class='whitefield' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<INPUT id='navNext' type='button' value='&gt;' class='whitefield' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var gcWorkday="#FD7922";	// Workday font color
var gcSat="#FD7922";	// Saturday font color
var gcSatBG="#FAE660";	// Saturday background color
var gcSun="#FD7922";	// Sunday font color
var gcSunBG="#FAE660";	// Sunday background color
...
var gcBGToday="#FD7922";	// the background color for today 
...
var gcBGSelected="#FD7922";	// the background color for the selected date
