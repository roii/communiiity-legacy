...
<cfelse>
	<a href="##" onclick="javascript:window.open('#request.webroot#/Campaigns/dsp_ExpressInterest.cfm?CampaignsID=#trim(url.CampaignsID)#&projectTitle=#TRIM(CampaignsDetails.title)#&userID=#session.UserID#','popup','width=500,height=800');">#clickherehotlink#</a>.
...
<h3>#leavecomments#</h3>
<form action="#request.webroot#/index.cfm?fuseaction=Campaigns&fusesubaction=insertcomment" method="post" name="commentform">
