	...
	<script type="text/javascript" src="/assets/igg/projects/follow_link-d4ce5aef9fbe6a77b4cdfe5f13449a06.js"></script>
		<span class="fr add-to-favorites"> 
			 ...
			 <cfif #getFollowedD.recordcount# gt 0>
				  <a class="unfollow" href="javascript: void(0);" style="color: ##FF0051; text-decoration: none;" onclick="javascript: followunfollow('yes', #userid#, '#URLEncodedFormat(userip)#', #campaign_id#);"> 
					 <span id="flluntextID">UnFollow</span>
				  </a> 
			 <cfelse>
				  <a class="follow" href="javascript: void(0);" style="color: ##FF0051; text-decoration: none;" onclick="javascript: followunfollow('no', #userid#, '#URLEncodedFormat(userip)#', #campaign_id#);">
					 <span id="flluntextID">Follow</span>
				  </a>	  
			 </cfif>	  
		</span>
</div> 
