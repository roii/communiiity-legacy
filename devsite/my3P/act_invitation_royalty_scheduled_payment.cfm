...
<cfif TRIM(AllMembers.ReferralCode) NEQ ''>
	...
	<cfquery name="ReferDetails" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfif ReferDetails.RecordCount>	
		...
		<!--- CHECK FOR INVITE --->
		<cfquery name="checkinvite" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfelse>
			...
			<!--- CREATE INVITE --->
			<cfquery name="LastInviteID" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r" maxrows="1">
			SELECT InvitationID
			FROM Invitations
			...
			<cfquery name="AddInvite" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfquery name="qry_all_transactions" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfloop query="qry_all_transactions">
			...
			<cfquery name="Update_Transaction" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfif total_amount_percentage GT 0>
			...
			<cfif amount_to_pay GT 0>
				...
				<cfquery name="UpdateRoyaltiesEarned" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
				UPDATE Invitations
...
<cfquery name="updateSchedule" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
