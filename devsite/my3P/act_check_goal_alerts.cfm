...
<cfquery name="RemindersLastSent" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<cfif DateCompare(DateAdd('h', 24, RemindersLastSent.GoalRemind_LastSent), localDateTime) EQ -1>
	...
	<cfquery name="AllActiveGoals" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfloop query="AllActiveGoals">
		...
		<cfif IsDate("#this_LastSent#")>
			...
			<cfquery name="UpdateGoalLastSent" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
			UPDATE  Goals
	...
	<!--- UPDATE WHEN GOAL REMINDERS LAST SEND --->
	<cfquery name="UpdateLastSent" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
