...
<cfquery name="AllPermissions" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
SELECT PermissionID
FROM Permissions
...
<cfif IsDefined("form.LoginName") AND IsDefined("form.Password") AND TRIM(form.Password) NEQ ''>
		...
		<cfelse>
			...
			<cfif TRIM(passwords.Roles) NEQ ''>
				...
				<cfloop list="#passwords.Roles#" index="thisRole" delimiters=",">
					...
					<cfquery name="Userpermissions" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
					SELECT *
	...
	<cfelse>			
		...
		<cfquery name="AdminPasswords" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		SELECT *
		FROM Administrator
