...
<cfif photo_upload_name NEQ ''>
	...
	<cfx_image action="resize" file="#request.fileroot#\images\alantest\#photo_upload_name#" x="80" quality="75" output="#request.fileroot#\images\alantest_thumb\#photo_upload_name#"> 
