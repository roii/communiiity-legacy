...
<%@ Page Language="c#" Inherits="SqlWebAdmin.RenameTable" CodeFile="RenameTable.aspx.cs" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Web Data Administrator - Rename Table</title>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td bgcolor="white" class="databaseListItem">
                                            Choose a new name for the table:
                                            <br>
                                            <br>
                                            <asp:TextBox runat="server" ID="TableNameTextBox"></asp:TextBox>
                                            <asp:Button runat="server" ID="RenameButton" CssClass="button" onMouseOver="this.style.color='#808080';"
                                                onMouseOut="this.style.color='#000000';" Text="Rename" OnClick="RenameButton_Click">
                                            </asp:Button>
                                            <asp:Button runat="server" ID="CancelButton" CssClass="button" onMouseOver="this.style.color='#808080';"
