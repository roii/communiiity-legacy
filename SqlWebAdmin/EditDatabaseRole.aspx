<%@ Page Language="c#" Inherits="SqlWebAdmin.EditDatabaseRole" CodeFile="EditDatabaseRole.aspx.cs" %>
                                        ...
                                        <td bgcolor="white" class="databaseListItem">
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="databaseListItem">
                                                        <asp:Label ID="RoleTypeLabel" runat="server" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="databaseListItem" align="right">
                                                        <asp:Button Text="Save Role" OnClick="Save_Click" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
