<%@ Page Language="c#" Inherits="SqlWebAdmin.CreateDatabaseUser" CodeFile="CreateDatabaseUser.aspx.cs" %>
                                        ...
                                        <td bgcolor="white" class="databaseListItem">
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="databaseListItem">
                                                        <asp:DropDownList ID="Logins" DataValueField="Name" OnChange="ChangeUser(this)" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="databaseListItem">
                                                    ...
                                                    <td class="databaseListItem">
                                                        <asp:TextBox ID="Username" MaxLength="128" runat="server" />
                                                ...
                                                <tr>
                                                    <td colspan="2" align="right">
                                                        <asp:Button ID="CreateButton" Text="Create User" OnClick="Create_Click" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                            <br />
