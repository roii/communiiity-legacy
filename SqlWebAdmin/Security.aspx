<%@ Page Language="c#" Inherits="SqlWebAdmin.Security" CodeFile="Security.aspx.cs" %>
...
<html>
<head>
    <title>Web Data Administrator - Security</title>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr>
                                        <td bgcolor="white" class="databaseListItem">
                                            <table cellpadding="4" style="width:200px; height:120px; background-image:url(images/bg_security.gif); background-repeat:repeat">
                                                <tr>
                                                    <td>
                                                    <img src="images/spacer.gif" width="1" height="4" alt="" border="0">
                                                    </td>
                                                    <td>
                                                        <a href="ServerLogins.aspx">
                                                            <img src="images/Server_Logins.gif" border="2" style="border-color:Blue">
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="ServerRoles.aspx">
                                                            <img src="images/Server_Roles.gif" border="2" style="border-color:Blue">
                                                        </a>
                                                    </td>
                                                </tr>
                                            </table>
