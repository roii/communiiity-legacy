<%@ Page Language="c#" Inherits="SqlWebAdmin.DatabaseRoles" CodeFile="DatabaseRoles.aspx.cs" %>
                            ...
                            <td align="left" class="databaseListItem" width="100%">
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <%--
                                        <tr>
                                            <td align="right">
                                                <asp:HyperLink Runat="server" CssClass="createLink" ID="CreateRoleLink">
                                                    <img src="images/new.gif" width="16" height="16" alt="" border="0">
                                                    <span style="position:relative; top: -3px;">Create new role</span>
                                                </asp:HyperLink>
                                            </td>
                                        </tr>
                                        --%>
                                    <tr>
                                        <td bgcolor="white" class="databaseListItem">
                                            <asp:DataGrid ID="RolesGrid" runat="server" GridLines="None" Border="0" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <%--
                                                        <asp:TemplateColumn>
                                                            <ItemTemplate>
                                                                <a href=DeleteDatabaseRole.aspx?database=<%=Request["database"]%>&role=<%#((SqlDatabaseRole)Container.DataItem).Name%>>Delete</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        --%>
                                                </Columns>
