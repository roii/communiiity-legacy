...
<cfquery name="SurveyCheck" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
SELECT *
...
<cfif session.UserIsAuthenticated EQ 'yes'>
	...
	<cfif SurveyCheck.RecordCount>
		...
		<cfquery name="UserCompleted" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
		SELECT AnswerID
