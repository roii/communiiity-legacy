...
<cfelse>
	<a href="##" onclick="javascript:window.open('#request.webroot#/projects/dsp_ExpressInterest.cfm?projectID=#trim(url.projectID)#&projectTitle=#TRIM(projectdetails.title)#&userID=#session.UserID#','popup','width=500,height=800');">#clickherehotlink#</a>.
