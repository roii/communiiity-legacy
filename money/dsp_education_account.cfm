...
<cflock Type="exclusive" scope="session" timeout="10">
	<cfparam name="session.educationAcc_StartRow" default="1">
</cflock>

<cfif isdefined("educationAcc_StartRow")>	
	<cflock Type="exclusive" scope="session" timeout="10">
		<cfset session.educationAcc_StartRow = educationAcc_StartRow>
	</cflock>
</cfif>


<cflock Type="exclusive" scope="session" timeout="10">	
	<cfparam name="session.educationAcc_MaxRows" default="20">
</cflock>

<cfif isdefined("educationAcc_MaxRows")>	
	<cflock Type="exclusive" scope="session" timeout="10">
		<cfset session.educationAcc_MaxRows = educationAcc_MaxRows>
	</cflock>
</cfif>
...
<td>
	...
	<cfif session.educationAcc_MaxRows NEQ 'ALL'>
	
		<cfif TransactionHistory.RecordCount GT (session.educationAcc_StartRow + session.educationAcc_MaxRows)-1>
			<cfset money_endrow = session.educationAcc_StartRow + session.educationAcc_MaxRows-1>
		<cfelse>
	...
	<!--- SET THE PREV VALUE --->
	<cfif session.educationAcc_StartRow GT session.educationAcc_MaxRows>
		<cfset prev = session.educationAcc_StartRow - session.educationAcc_MaxRows>
	
	<cfelse>
		<cfset prev = session.educationAcc_StartRow>
	...
	<cfelse>
		<cfset next = session.educationAcc_StartRow>
	...
	<cfif session.educationAcc_MaxRows NEQ 'ALL'>
		...
		<cfset NumberCount=(TransactionHistory.RecordCount / session.educationAcc_MaxRows)>
	...
	<td width="100%" bgcolor="White">
		...
		<cfif TransactionHistory.RecordCount>
			...
			<td class="small" style="color:###TRIM(AllSettings.DkBoxTextColour)#;font-size:11px;"><strong>#TransactionHistory.RecordCount#</strong> transaction records. Displaying records <strong>#session.educationAcc_StartRow# - #money_endrow#</strong></td>
			<td align="right" style="color:###TRIM(AllSettings.DkBoxTextColour)#;font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;::: View - <a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_MaxRows=10&educationAcc_StartRow=1&documentID=#DocumentID#" style="color:###TRIM(AllSettings.DkBoxTextColour)#;">10</a> | <a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_MaxRows=20&educationAcc_StartRow=1&documentID=#DocumentID#" style="color:###TRIM(AllSettings.DkBoxTextColour)#;">20</a> | <a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_MaxRows=50&educationAcc_StartRow=1&documentID=#DocumentID#" style="color:###TRIM(AllSettings.DkBoxTextColour)#;">50</a> | <a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_MaxRows=ALL&educationAcc_StartRow=1&documentID=#DocumentID#" style="color:###TRIM(AllSettings.DkBoxTextColour)#;">ALL</a></td>
			</tr>
			...
			<td colspan="7"><hr width="100%" color="###TRIM(AllSettings.TextColour)#" size="1"></td>
				...
				<cfloop query="TransactionHistory" startrow="#session.educationAcc_StartRow#" endrow="#money_endrow#">
				...
				<div align="right" style="font-size:11px;"><cfif session.educationAcc_StartRow GT session.educationAcc_MaxRows>&lt; <a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_StartRow=#prev#&documentID=#DocumentID#">Prev Page</a> | </cfif><cfif money_endrow LT TransactionHistory.RecordCount><a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_StartRow=#next#&documentID=#DocumentID#">Next Page</a> &gt;</cfif><cfif session.educationAcc_MaxRows NEQ 'ALL'> ::: <cfloop from="1" to="#moneyNumberCount#" index="NumberCount"><cfset thisStartRow=(session.educationAcc_MaxRows*NumberCount-session.educationAcc_MaxRows+1)><cfif thisStartRow EQ session.educationAcc_StartRow><span style="text-decoration:none;"><cfelse><a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&educationAcc_StartRow=#thisStartRow#&documentID=#DocumentID#"></cfif>#NumberCount#<cfif thisStartRow EQ session.educationAcc_StartRow></span><cfelse></a></cfif><cfif NumberCount NEQ moneyNumberCount> - </cfif></cfloop></cfif>&nbsp;&nbsp;&nbsp;</div>
