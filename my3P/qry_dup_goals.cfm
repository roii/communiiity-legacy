...
<cfquery name="CurrentPrivateGoals" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<cfquery name="DupGoal" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
SELECT Goals.GoalID
FROM Goals, GoalKidsLink
...
<cfquery name="DeleteDupGoal" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
DELETE
FROM Goals
