<!--- GET DRAW DETAILS --->
<cfquery name="qry_draw_details" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
SELECT * 
...
<cfloop list="#qry_draw_details.Winners#" index="loopitem" delimiters=",">
	...
	<!--- GET WINNER DETAILS --->
	<cfquery name="WinnerDetails" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfif IsNumeric("#this_mobilenumber#")>
		 ...
		 <!--- GET DEFAULT TAGLINE --->
		<cfquery name="DefaultTag" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		SELECT TagLine
		FROM SMS_Taglines
		WHERE DefaultTag=1
		...
		<!--- LOG TXT --->
		<cfquery name="LogTxtMessage" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<!--- UPDATE DRAW AS PAID --->
<cfquery name="updateqry_draw_details" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
