...
<cfquery name="AllLinks" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<cfquery name="UpdateLinkTable_#AllLinks.CurrentRow#" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<cfif TRIM(this_EmailAddress) NEQ ''>
	...
	<cfquery name="CheckIfMember" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	SELECT ContactID
	FROM Contacts
	...
	<cfif CheckIfMember.RecordCount>
		...
		<cfquery name="UpdateToContact" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		UPDATE KidClientLinks
		...
		<cfquery name="DeleteClient" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		DELETE
		FROM Contacts
