...
<cfloop query="MemberDetails">
	...
	<!--- GET ALL IDEAS --->
	<cfquery name="qry_all_ideas" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfif IsNumeric("#TotalUserPointsIn#") AND TotalUserPointsIn GT 0>
	 ...
	 <!--- POINTS FROM IDEAS --->
	 <cfquery name="qry_idea_points" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="AllInvites" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="qry_all_goals" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	SELECT Goals.GoalID
	...
	<cfquery name="qry_complete_goals" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	SELECT Goals.GoalID
	FROM Goals, GoalKidsLink
	WHERE Goals.GoalID=GoalKidsLink.GoalID
	AND GoalKidsLink.KidsID = #this_contactID#
