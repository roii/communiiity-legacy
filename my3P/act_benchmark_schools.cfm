<!--- GET ALL SCHOOLS --->
<cfquery name="AllActiveSchools" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<cfloop query="AllActiveSchools">
	...
	<cfif AllKids.RecordCount>
		...
		<cfquery name="AllStudentGoals" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfquery name="StudentIdeas" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="UpdateSchool" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	UPDATE Schools
...
<cfquery name="UpdateSchoolBenchmarking" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
