<cfloop list="19658, 33844, 33846, 18984, 16805, 16806, 19845, 33866, 27910, 27911, 27912, 27913, 27914, 27915, 33823, 27908" index="goal" delimiters=",">
	...
	<cfquery name="qry_all_updates" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="qry_contact_details" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	SELECT ContactID, FirstName, LastName, ScreenName
	FROM Contacts
	WHERE ContactID=#qry_all_updates.ContactID#
	</cfquery>
	
	<cfquery name="qry_goal_details" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	SELECT GoalTitle
	FROM Goals
	WHERE GoalID=#goal#
	</cfquery>
