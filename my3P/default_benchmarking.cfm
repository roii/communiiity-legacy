<cfquery name="MemberDetails" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
SELECT ContactID
FROM Contacts
...
<cfloop query="MemberDetails">
	...
	<cfquery name="AllUnAuthorisedIdeas" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="AllAuthorisedIdeas" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="AllGoals" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<!--- GET ALL BUSINESSES --->
	<cfquery name="AllBusinesses" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="AllPrizesWon" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="AllPrizeEntries" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="AllRewardsPurchased" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="CashIn" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="CashOut" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="EducationIn" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="EducationOut" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	...
	<cfquery name="DeleteOld" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
	DELETE
	...
	<cfquery name="insertBenchmarking" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
