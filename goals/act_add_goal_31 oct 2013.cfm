...
<cfcatch>
	...
	<cfabort>
		...
		<cfquery name="AddGoal" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
		INSERT INTO Goals(
		GoalTypeID,
		GoalTitle,
		GoalCatID,
		...
		<cfquery name="AddKidsGoal" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
