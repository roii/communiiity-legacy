...
---> 
	...
	VALUES(#newid#, '#form.title#', #FORM.related_campaign# , '#form.title#', '#form.details#', '#form.CreditsOffered#', '#form.currentstatus#', '#form.percentcomplete#', '#form.assignedto#', '#localImage1#', '#FORM.userid#', '#form.ProjectPriority#'
