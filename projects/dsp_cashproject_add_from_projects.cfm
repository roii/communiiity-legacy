	...
	<cfoutput>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<br>
				...
				<td class="normal" valign="top"> 
				      <input type="text" name="Title" id="Title" class="whitefield" value="" size="80" />
				</td>
				</tr>
				<!---<tr>
				<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
				...
				<td class="normal" valign="top">
					 <p>  
						<input type="text" name="skillsNeeded" id="skillsNeeded" class="whitefield" value="" size="80" />
					 </p>
				     <p style="color:blue;">
				      ...
				      <table width="100%" cellpadding="0" cellspacing="0" border="0">
						   <tr>
								  <td valign="middle" width="15%">
									   <input type="text" Class="whitefield" size="18" name="start_date" value="" id="start_date" readonly="readonly">
								  </td>
				...
				<td Class="normal" valign="top">
				      <table width="100%" cellpadding="0" cellspacing="0" border="0">
						   <tr>
								  ...
								  <td valign="top" width="85%">
									   <img width="32" height="32" border="0" src="#request.webroot#/images/Actions-edit-clear-icon.png" alt="clear start date" title="clear start date" onClick="clearDate('finish_date');" style="cursor: pointer;">
								  </td>
						   </tr>
					  </table> 
				</td>
