...
SELECT P.CampaignsID, P.INTROTEXT, P.ProjectCategoryID,P.Title,P.CurrentStatus,P.PaymentType,P.PaidIn,p.Priority, P.CreditsOffered, P.campaignspic, P.details, P.addedby, P.location, P.campaigns_order, P.displaycampaigns, P.PercentComplete, P.MainProjectCategoryID
