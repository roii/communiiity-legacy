...
<cfelse>
	...
	<td class="normal" valign="top">
		 <p>  
			<input type="text" name="skillsNeeded" id="skillsNeeded" class="whitefield" value="#TRIM(ProjectDetails.skills)#" />
		 </p>
	...
	<td Class="normal" valign="top"><input type="text" Class="whitefield" size="18" name="start_date" value="#startdateV#" id="start_date" readonly="readonly"></td>
	</tr>
	...
	<td Class="normal" valign="top"><input type="text" Class="whitefield" size="18" name="finish_date" value="#finishdateV#" id="finish_date" readonly="readonly"></td>
	</tr>
