<cfcomponent displayname="Application" output="true" hint="Handle the application.">
    ...
    <cffunction name="OnApplicationStart" access="public" returntype="boolean" output="false" hint="Fires when application created.">
        <cfscript>
            ...
            application.redirect_uri = "http://communautiii.com/multiLogin/processLogin.cfm";
            //TWITTER
            ...
            application.facebook_appid = "572038086219950";
            application.facebook_secret = "3adb8ad30889480921f379228c10ef2b";
            application.facebook_baseurl = "https://www.facebook.com/dialog/oauth";
            application.facebook_redirecturl = "http://communautiii.com/multiLogin/processLogin.cfm";
            //LINKEDIN
