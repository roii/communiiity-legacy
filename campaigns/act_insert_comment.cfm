...
<cfset aResponse = listToArray(cfhttp.fileContent, chr(10))>
	...
	<cflocation url="#request.webroot#/index.cfm?fuseaction=Campaigns&fusesubaction=docs&documentID=#form.documentID#&projectmode=#form.projectmode#&ProjectCategoryID=#form.ProjectCategoryID#&CampaignsID=#form.CampaignsID#">
<cfelse>
