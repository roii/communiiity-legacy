						...
						<td valign="middle"> 
								<cfset this_percentDone = getCampaigns.dashboard_var_1_percentage>
								 <cfif this_percentDone neq '' and this_percentDone gt 0>  
									 ...
									 <iframe src="#request.webroot#/campaigns/display_progress.cfm?percentValue=#this_percentDone#" width="217" style="width: 217px; height: 34px;" scrolling="no" frameborder="0"></iframe>
								 </cfif>
						</td>
				  </tr>
		  </cfif>	
