...
<cfquery name="AllSections" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
SELECT *
FROM Sections
WHERE Admin=1
ORDER BY MenuTitle
...
<hr width="100%" size="1" color="##e2e2e2"> --->
	...
	<tr>
	<td valign="top"><a href="#request.webroot#/index.cfm?fuseaction=#allsections.fuseaction#">#MenuTitle#</a></td>
	...
	<cftry><cfquery name="ContactTypeDetails" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
	SELECT ContactType
	FROM ContactTypes
	...
	<td align="right" valign="top"><a href="#request.webroot#/admin/dsp_section_edit.cfm?sectionID=#allsections.sectionID#&fuseaction=#fuseaction#&fusesubaction=#attributes.fusesubaction#" target="editsection" onclick="fdbackwindow=window.open ('','editsection','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=800,height=650,top=10,left=10')"><img src="#request.imageroot#/but_edit_icon.gif" width="10" height="10" alt="Edit Section" border="0"></a>&nbsp;<a href="javascript:confirmSectionDelete('#request.webroot#/admin/act_section_delete.cfm?sectionID=#allsections.sectionID#')"><img src="#request.imageroot#/but_delete_icon.gif" width="10" height="10" alt="Delete Section" border="0"></a></td>
	</tr>
