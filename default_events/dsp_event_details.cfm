...
<html>
<head>
	<title>Guidelines International Network - Event Details</title>
...
<td background="#request.imageroot#/top_blue_pattern.gif" valign="middle" valign="top" height="40"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Upcoming Event Details</strong></span></td>
</tr>
...
<br>
	...
	<span class="page_header"><b>#EventDetails.EventTitle#</b></span></td>
  	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	</tr>
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>	
    <td colspan="2"><cfif EventDetails.IncludeRegForm eq 1><input type="button" class="whitefield" value="Register Online >>" onclick="javascript:location='dsp_registerNow.cfm?eventID=#EventID#';">&nbsp;&nbsp;&nbsp;</cfif><input type="button" class="whitefield" value="Close Window" onclick="javascript:window.close();"></td>
  	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	</tr>
