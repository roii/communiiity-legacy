...
<html>
<head> 
<cfif IsDefined("this_metatitle") and this_metatitle neq ''>
...
<title><cfif IsDefined("this_metatitle") and this_metatitle neq ''>#TRIM(this_metatitle)#<cfelse>#TRIM(AllSettings.SiteName)# - Tasks Page</cfif></title>
...
<div style="width: 100%; background: none repeat scroll 0 0 ##DCDEED;">

      <cfinclude template="../templates/header_include.cfm"> 
	  
	  <div class="content" style="background: none repeat scroll 0 0 ##DCDEED;">
...
<cfelse>
  <div class="container">
	...
	<td width="100%" style="padding-left:10px;padding-right:10px;" colspan="3">
	   ...
	   <cfif attributes.fusesubaction EQ 'editTask'> 
	           <a href="#request.webroot#/index.cfm?fuseaction=tasks&fusesubaction=index&documentID=#URL.documentID#&projectmode=template&ProjectCategoryID=#URL.ProjectCategoryID#&ProjectID=#URL.ProjectID#&campaignID=#URL.campaignID#&maintask=#URL.maintask#" style="text-decoration: none; color: black;">
			       Go Back to Task Page
			   </a> 
			   <br><br>
	   <cfelse>
           <div style="font-size: 21px; font-weight: bold;">#browse# <span style="color: ##91AE4E;">#tasks#</span></div>  
	   </cfif>	   
			...
			<cfelseif attributes.fusesubaction EQ 'editTask'>
			
				
				<cfinclude template="dsp_task_edit.cfm">
