...
<SELECT NAME="selCategory" onchange="location = this.options[this.selectedIndex].value;">
	...
	<cfoutput><OPTION VALUE="#request.webroot#/index.cfm?fuseaction=projects">Show them all!</cfoutput>
...
<SELECT NAME="selStatus" onchange="location = this.options[this.selectedIndex].value;">
	...
	<cfoutput>
	<OPTION VALUE="#request.webroot#/index.cfm?fuseaction=projects">Show them all!
	<OPTION VALUE="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=#url.documentID#&selStatus=Being Planned&selCategory=#amarCatDetails.ProjectCategoryID#&groupID=#groupID#" <cfif selStaus eq "Being Planned">Selected</cfif>>Being Planned</option>
	<OPTION VALUE="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=#url.documentID#&selStatus=Available Now&selCategory=#amarCatDetails.ProjectCategoryID#&groupID=#groupID#" <cfif selStaus eq "Available Now">Selected</cfif>>Available Now</option>
	<OPTION VALUE="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=#url.documentID#&selStatus=In progress&selCategory=#amarCatDetails.ProjectCategoryID#&groupID=#groupID#" <cfif selStaus eq "In progress">Selected</cfif>>In progress</option>
	<OPTION VALUE="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=docs&documentID=#url.documentID#&selStatus=All Done&selCategory=#amarCatDetails.ProjectCategoryID#&groupID=#groupID#" <cfif selStaus eq "All Done">Selected</cfif>>All Done</option>
	</cfoutput>
</SELECT>
<p/>
...
<td style="color:###TRIM(AllSettings.DkBoxTextColour)#; line-height:110%;" align="center"><b>Category</b></td>
<td style="color:###TRIM(AllSettings.DkBoxTextColour)#; line-height:110%;" align="center"><b>Priority</b></td>
...
<td nowrap valign="top" align="center">#TRIM(ProjectDetails.ProjectID)#</td>
...
<td nowrap valign="top" align="center">#TRIM(CatDetails.CategoryTitle)#</td>
<td nowrap valign="top" align="center">#TRIM(ProjectDetails.Priority)#</td>
