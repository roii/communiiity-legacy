...
<cfif FORM.fromProject eq 0>
     <cflocation url="#request.webroot#/projects/#FORM.projectBackID###tabs1-projects" addtoken="no">
<cfelse>
     <cflocation url="#request.webroot#/index.cfm?fuseaction=tasks" addtoken="no">	 
</cfif>
<!---</cfif>--->
