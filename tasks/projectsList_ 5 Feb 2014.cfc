...
<cffunction name="getProjectsList" access="remote" returntype="any" returnformat="plain" output="false">
		...
		<cfif isDefined("arguments.selCategory")>
		     <cfif arguments.selCategory neq ''>
			   <cfif arguments.selCategory neq 'showallcats'> 
				  and P.ProjectCategoryID IN (#trim(arguments.selCategory)#)
			   </cfif>	  
			 </cfif> 
		</cfif>
	...
	<cfloop query="this_page"> <!---the grid wants the data inthis format [id,cell{column,column...}]---> 
				...
				<cfif this_page.Priority eq "High">
					<cfset tmp2.cell[5] = '<img align="center" src="#arguments.webroot#/images/dot-red.gif" style="text-align: center; padding-left: 27px;">'>
				<cfelseif this_page.Priority eq "Low">
					<cfset tmp2.cell[5] = '<img align="center" src="#arguments.webroot#/images/dot_green.gif" style="text-align: center; padding-left: 27px;">'>
				<cfelseif this_page.Priority eq "Normal" or this_page.Priority eq "Medium">
					<cfset tmp2.cell[5] = '<img align="center" src="#arguments.webroot#/images/yellow.gif" style="text-align: center; padding-left: 27px;">'>
				<cfelse>
					<cfset tmp2.cell[5] = this_page.Priority>
				</cfif>
