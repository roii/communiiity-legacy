...
SELECT P.ProjectID, P.INTROTEXT, P.ProjectCategoryID,P.Title,P.CurrentStatus,P.PaymentType,P.PaidIn,p.Priority,PC.Title ProjectCategory, P.CreditsOffered, P.projectpic
				    ...
				    <div class="fl badge rounded shadow -ce-capture "> 
						...
						<div class="project-details" style="word-wrap: break-word; color: black;">
						  <span style="margin-top: 10px; color: blue; display: block;">
						    ...
						    <span style="margin: 10px; color: black; display: block;">
