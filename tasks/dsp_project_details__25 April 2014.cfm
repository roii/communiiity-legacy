...
<tr>
	...
	<td style="text-align:right;">#commentadd#: #trim(ProjectComments.DateAdded)#
	    <cfif #ProjectComments.CONTACTID# eq #projectDetails.PROJECT_OWNER#>
	       <a href="##">Edit Comments</a> &nbsp; <a href="javascript: void(0);" onclick="deleteComments(#ProjectComments.COMMENTID#, #url.ProjectCategoryID#, #TRIM(ProjectDetails.ProjectID)#, #URL.campaignID#);">Delete Comments</a>
	    </cfif>
	</td>
</tr>
<tr>
