...
<td align="center" height="20" colspan="3">
	...
	<tr>
	<td style="font-size:14px;font-family:ArialBlack;color:###TRIM(AllSettings.BoxColour)#;" valign="bottom"><strong>Our rewards as goals</strong></td>
	<td align="right" valign="bottom"><!--- <img src="#request.imageroot#/SiteIcons/rewards_sml.jpg" alt="Rewards" border="0"> ---></td>
	</tr>
