...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="2" border="0"><br>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Number of Charities:</td>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Total points earned for charities:</td>
