...
<tr>
<td width="100%" style="font-size:12px;color:###TRIM(AllSettings.DkTextColor)#" height="20"><strong>#manageactrew#</strong></td>
...
<strong>#addanact# &raquo;</strong></a>
	...
	<td align="center"><b>#prizeentries#</b></td>
