...
<html>
<head>
	<title>G-I-N - Edit this Administrator</title>
...
<td background="#request.imageroot#/top_blue_pattern.gif" valign="middle" valign="top" height="40"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Edit this Administrator</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_administrator_edit.cfm" name="AdministratorAddForm">
