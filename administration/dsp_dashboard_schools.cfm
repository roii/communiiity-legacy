...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="2" border="0"><br>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">#noofschools#:</td>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">#schoolsregmem#:</td>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">#staffregister#:</td>
