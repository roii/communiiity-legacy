...
<tr>
<td width="100%" style="font-size:12px;color:###TRIM(AllSettings.DkTextColor)#" height="20"><strong>#manageadminN#</strong></td>
...
<tr>
<td class="small"><a href="#request.webroot#/admin/dsp_administrator_add.cfm" target="addAdmin" ONCLICK="fdbackwindow=window.open ('','addAdmin','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=700,height=240,top=10,left=10')" style="color:###TRIM(AllSettings.BoxColour)#; text-decoration:none;"><strong>#addanadminN# »</strong></a>
...
<hr width="100%" size="1" color="e2e2e2">
	...
	<td><span class="normal"><b>#emailaddress#</b></span></td>
	<td><span class="normal"><b>#PasswordText#</b></span></td>	
