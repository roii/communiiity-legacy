...
<html>
<head>
	<title>#TRIM(AllSettings.SiteName)# - Add Promo Code</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add Promo Code</strong></span></td>
</tr>
...
<br>
	...
	<form name="EditPromo" action="#request.webroot#/administration/act_add_promocode.cfm" method="post" onsubmit="javascript:validate(EditPromo); return false;">
	...
	<td><input type="text" name="PromoCode" class="whitefield" style="width:300px;"></td>
	</tr>
	...
	<td><input type="text" name="PromoName" class="whitefield" style="width:300px;"></td>
	</tr>
	...
	<td><textarea rows="5" name="Description" class="whitefield" style="width:300px;"></textarea></td>
	</tr>
	...
	<td><input type="text" name="Points" class="whitefield" style="width:300px;"></td>
	</tr>
	...
	<td><input type="text" name="ExpireDate" class="whitefield" style="width:300px;"><a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.EditPromo.ExpireDate);return false;" hidefocus><img name="popcal" align="absmiddle" src="#request.imageroot#/calbtn.gif" width="34" height="22" border="0" alt=""></a></td>
	</tr>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td><input type="submit" value="ADD PROMO CODE >>" class="whitefield"> &nbsp; <input type="button" onclick="window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
