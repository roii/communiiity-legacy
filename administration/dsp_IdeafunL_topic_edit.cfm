...
<br>
	...
	else if (AddTopic.related_campaign.value == "") {
		alert("You must select the Campaign for this topic.");
		AddTopic.related_campaign.focus();
		return;
		}	
	...
	<form name="AddTopic" action="#request.webroot#/administration/act_edit_ideafunl_topic.cfm" method="post" onSubmit="javascript:validate(AddTopic); return false;" enctype="multipart/form-data">
...
<cfloop query="qry_maincategory_stuff">
	...
	<td><select name="related_campaign" id="related_campaign" style="width:300px;">
		    ...
		    <cfloop query="getCampaigns">
		        <option value="#getCampaigns.CampaignsID#" <cfif #qry_category_stuff.related_campaign# eq #getCampaigns.CampaignsID#>selected="selected"</cfif> >#getCampaigns.Title#</option>
			</cfloop>
		</select> 
	</td>
	</tr>
	...
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td class="normal" valign="top" width="110">Ideas Pic</td>
	<td class="normal" valign="top">
	             <input type="file" name="ideas_pic" id="ideas_pic" value="" />
	...
	<td valign="top">
	<select name="Moderators" size="6" multiple class="whitefield" style="width:300px;">
