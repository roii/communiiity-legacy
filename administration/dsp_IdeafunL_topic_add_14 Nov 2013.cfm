...
<cfloop query="qry_maincategory_stuff">
	...
	<td><input type="text" name="PointsAllocated" class="whitefield" style="width:300px;"></td>
	</tr>	
	
	<tr>
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td style="font-size:11px;" width="110">New Idea Cut-Off</td>
	<td><input type="text" name="PointsCutOff" class="whitefield" style="width:300px;"></td>
	</tr>
