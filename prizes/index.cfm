...
<cfif IsDefined("URL.fusesubaction") and URL.fusesubaction neq ''>
     <cfset fusesubaction = URL.fusesubaction>
<cfelse>
     <cfset fusesubaction = ''>
</cfif>

<cfif documentid eq 0 and fusesubaction eq ''>
    <cflocation url="#request.webroot#/index.cfm?fuseaction=prizes&fusesubaction=docs&documentid=62" addtoken="no">
</cfif>
			       ...
			       <!--- MAIN LAYOUT - Leftside column, main column, rightside column ---> 
					<tr> 
						...
						<cfif attributes.fusesubaction EQ 'index'>
							...
							<cfelse>
								<cflocation url="#request.webroot#/index.cfm?fuseaction=prizes&fusesubaction=docs&documentID=62">
							</cfif>
						...
						<cfelseif attributes.fusesubaction EQ 'docs'>
								...
								<cfif DocumentID EQ 50>
									<cfinclude template="dsp_how_to_win.cfm">
								
								<cfelseif DocumentID EQ 51>
									<cfinclude template="dsp_prize_watchlist.cfm">
								  
								<cfelseif DocumentID EQ 52>
									<cfif IsDefined("InviteFriendList")>
										<cfinclude template="dsp_invitefriend_won.cfm">
									<cfelse>
										<cfinclude template="dsp_prizes_won.cfm">
									</cfif>
									
								<cfelseif DocumentID EQ 61 OR DocumentID EQ 62>
									<cfinclude template="dsp_current_prizepool.cfm">
								
								<cfelseif DocumentID EQ 91>
									<cfinclude template="dsp_reward_request.cfm">
