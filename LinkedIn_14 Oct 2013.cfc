...
<cfcomponent displayname="LinkedIn.cfc" hint="Functions to interact with LinkedIn API" output="yes">	
	<cfscript>
		variables.callback = "http://www.iii.coop/CallBack.cfm"; // SET THIS TO THE FULL URL OF YOUR CALLBACK  
		variables.apiKey = "vyyzry9q70pq";
		variables.secretKey = "hRkm08JVWtCAqFve";		
		//DO NOT CHANGE THESE
