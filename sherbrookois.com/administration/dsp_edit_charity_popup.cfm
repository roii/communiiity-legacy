...
<html>
<head>
<title>#TRIM(AllSettings.SiteName)# - Manage Charity</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Manage Charity</strong></span></td>
</tr>
