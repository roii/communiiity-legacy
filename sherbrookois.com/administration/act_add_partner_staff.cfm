...
<cfelse>
	...
	VALUES(#newid#, 7, 'Active', #createODBCDateTime(localDateTime)#, '#form.FirstName#', '#form.LastName#', '#form.EmailAddress#', 1, '#form.Profile_Password#', 1, #form.OrganisationID#, 0)
	</cfquery>


	<cflocation url="#request.webroot#/administration/dsp_edit_partner_popup.cfm?OrganisationID=#form.OrganisationID#&updatemode=stafflist">
