...
<!--- UPDATE CHARITY WITH PRIMARY CONTACT ID --->
...
<!--- CLOSE THE POP-UP AND REFRESH THE CALLING PAGE --->
	...
	function showParentAndClose(givenURL) {
	    alert("You have successfully added the charity");
	...
	<cfoutput>
		...
		<body onload="showParentAndClose('#request.webroot#/index.cfm?fuseaction=administration&fusesubaction=manage_charities')"></body>
