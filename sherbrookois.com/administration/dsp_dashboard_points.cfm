...
<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="2" border="0"><br>
	...
	<td style="color:Black;font-size:11px;padding-right:5px;" align="center" width="100">#INT(totalearned_points)#</td>
	</tr>
	...
	<tr>
	<td style="color:Black;font-size:11px;padding-left:5px;">Redeemed:</td>
	<td style="color:Black;font-size:11px;padding-right:5px;" align="center" width="100">#INT(totalspent_points)#</td>
	</tr>
	...
	<td style="color:Black;font-size:11px;padding-right:5px;" align="center" width="100">#INT(balance_points)#</td>
	</tr>
