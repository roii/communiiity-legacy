...
<br>
	...
	<form name="editGoalCat" action="#request.webroot#/administration/act_add_goalcat.cfm" method="post" enctype="multipart/form-data">
	...
	<td><input type="text" name="CategoryName" class="whitefield" style="width:300px;"></td>
	</tr>
	...
	<td class="normal" style="color:##444444;font-size:11px;"><input type="file" name="ImageFile" class="whitefield" style="width:300px;"><br>NOTE: Resizes to 80px(w) x 60px(h) when creating the thumbnail.<br>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td>Display Order</td>
	<td><input type="text" Class="whitefield" size="15" name="DisplayOrder"></td>
	</tr>		
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td> </td>
	<td><input type="submit" onclick="javascript:validate(editGoalCat); return false;" value="ADD CATEGORY NOW >>" class="whitefield"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
