...
<hr width="100%" size="1" color="e2e2e2">
	...
	<cfquery name="CheckLogin" datasource="#dsn#" username="#request.username#" password="#request.password#" maxrows="1">
	...
	<cfelse>
		...
		<cfquery name="CheckInvitation2" datasource="#dsn#" username="#request.username#" password="#request.password#">
	...
	<cfif IsDefined("Totalkidsconfirmed.RecordCount") and Totalkidsconfirmed.RecordCount gt 0 and IsDefined("TotalKids.RecordCount") and TotalKids.RecordCount gt 0>
         <cfset confirmrate = Totalkidsconfirmed.recordcount / TotalKids.recordcount * 100>
		    <br>
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
