...
<tr>
<td width="100%" style="font-size:12px;color:###TRIM(AllSettings.DkTextColor)#" height="20"><strong>ADMINISTRATION DASHBOARD</strong></td>
...
<tr>
<td colspan="2" style="color:###TRIM(AllSettings.DkTextColor)#"><strong>Report From:</strong> <input type="text" class="whitefield" name="Dashboard_StartDate" style="width:100px;" value="#DateFormat(session.Dashboard_StartDate, 'dd/mm/yyyy')#"><a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.DashForm.Dashboard_StartDate);return false;" hidefocus><img name="popcal" align="absmiddle" src="#request.imageroot#/calbtn.gif" width="34" height="22" border="0" alt=""></a> &nbsp;&nbsp;&nbsp; <strong>To</strong> <input type="text" class="whitefield" name="Dashboard_EndDate" style="width:100px;" value="#DateFormat(session.Dashboard_EndDate, 'dd/mm/yyyy')#"><a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.DashForm.Dashboard_EndDate);return false;" hidefocus><img name="popcal" align="absmiddle" src="#request.imageroot#/calbtn.gif" width="34" height="22" border="0" alt=""></a> &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" class="whitefield" style="color:###TRIM(AllSettings.DkTextColor)#" value="DISPLAY DASH &raquo;">
