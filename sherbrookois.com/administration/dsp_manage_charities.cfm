...
<tr>
<td width="100%" style="font-size:12px;color:###TRIM(AllSettings.DkTextColor)#" height="20"><strong>MANAGE CHARITIES</strong></td>
...
<a href="#request.webroot#/administration/dsp_add_charity.cfm" target="AddCharity" onclick="fdbackwindow=window.open ('','AddCharity','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=550,height=600,top=10,left=10')" style="color:###TRIM(AllSettings.BoxColour)#; text-decoration:none;"><strong>ADD A CHARITY &raquo;</strong></a><br>
...
<hr width="100%" size="1" color="e2e2e2">
	...
	<tr>
	<td colspan="7" bgcolor="###TRIM(AllSettings.BoxColour)#" height="20" style="color:white;">&nbsp;<strong>CHARITIES WITH MEMBERS</strong></td>
	</tr>
	...
	<td><a href="#request.webroot#/index.cfm?fuseaction=#fuseaction#&fusesubaction=#fusesubaction#&Charities_sortby=Countries.Name&sortorder=<cfif session.sortorder EQ 'ASC'>DESC<cfelse>ASC</cfif>"><strong>Country</strong></a></td>
	...
	<tr>
	<td colspan="7" bgcolor="###TRIM(AllSettings.BoxColour)#" height="20" style="color:white;">&nbsp;<strong>CHARITIES WITHOUT MEMBERS</strong></td>
	</tr>
	...
	<tr>
	<td><b>Total: #AllCharities.recordcount#</b></td>
	</tr>
