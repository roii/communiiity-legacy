...
FROM bizkidslink
WHERE DateCreated BETWEEN ('#DateFormat(session.Dashboard_StartDate, 'mm/dd/yyyy')# 00:00:01')
...
AND tranDate BETWEEN ('#DateFormat(session.Dashboard_StartDate, 'mm/dd/yyyy')# 00:00:01')
AND ('#DateFormat(session.Dashboard_EndDate, 'mm/dd/yyyy')# 23:59:59')
</cfquery>
...
<td>
	...
	<td style="color:Black;font-size:11px;padding-left:5px;">Businesses Started:</td>
	<td style="color:Black;font-size:11px;padding-right:5px;" align="center" width="100">#StartedBusiness.TotalStartedBiz#</td>
	</tr>
