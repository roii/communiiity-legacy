...
<!--- SEND THE HTML EMAIL --->				
<cfmail server="#application.emailserver#" to="#TRIM(InviteeDetails.EmailAddress)#" from="#TRIM(AllSettings.EmailAlertFrom)#" subject="#TRIM(NewAlertSubject)#" Type="HTML">
...
<cfmail server="#application.emailserver#" to="#TRIM(InviteeDetails.EmailAddress)#" from="#TRIM(AllSettings.EmailAlertFrom)#" subject="#TRIM(NewAlertSubject)#">#TRIM(NewAlertDetails)#</cfmail>
