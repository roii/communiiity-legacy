...
SELECT Library.RecordID, Library.Title, Library.FileSize, LibraryCats.LibraryCatTitle
...
<hr width="100%" size="1" color="silver">
	...
	<input type="hidden" name="DownloadID#AllLibraryFiles.currentrow#" value="#AllLibraryFiles.RecordID#">
	<tr>
	<td><input type="checkbox" name="DownloadAssociate#currentrow#" value="1" class="whitefield"<cfif #LISTFIND(CurrentDownloadLinks, RecordID, ',')#> checked</cfif>></td>
