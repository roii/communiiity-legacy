...
<html>
<head>
	<title>MyKidsBiz - Add Library Category</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add a Library Category</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_librarycat_add.cfm">
