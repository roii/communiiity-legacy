...
<br>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<form method="post" action="#request.webroot#/admin/act_add_note.cfm">
			<input type="hidden" name="contactID" value="#contactID#">

			<tr>
			<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
			<td>Note</td>
			<td><textarea name="kidsnote" rows="5" cols="35"></textarea></td>
			</tr>
			...
			<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
			<td > </td>
			<td><input type="submit" class="whitefield" style="" value="ADD NOW"> <input type="button" class="whitefield" value="CANCEL" onclick="window.close();"></td>
			</tr>
