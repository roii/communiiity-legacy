...
<html>
<head>
	<title>MyKidsBiz - Add Event Category</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add an Event Category</strong></span></td>
</tr>
...
<br>
	...
	<form method="post" action="act_eventcat_add.cfm">
	...
	<td class="normal" valign="top"><input name="EventCatName" class="whitefield" size="85"></td>
	</tr>
