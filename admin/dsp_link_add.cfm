...
<html>
<head>
	<title>MyKidsBiz - Add Link</title>
...
<td valign="middle" valign="top" height="40" bgcolor="###TRIM(AllSettings.BoxColour)#"><span style="color:white; font-size:14px; font-family:verdana;">&nbsp;&nbsp;<strong>Add a Link</strong></span></td>
</tr>
...
<br>
	...
	<cfform method="post" action="act_link_add.cfm" name="LinkAddForm">
	...
	<td class="normal" valign="top"><cfselect name="LinkCatID" display="Title" query="LinkCats" value="LinkCatID" class="whitefield"></cfselect></td>
	</tr>
	...
	<td class="normal" valign="top"><input type="text" Class="whitefield" size="85" name="LinkURL" value="http://"></td>
	</tr>
...
imageURL="#request.imageroot#/" width="445" height="220" toolbar="cut,copy,paste,|,undo,redo,|,quickfontsize,bold,italic,underline,|,outdent,indent,justifyleft,justifyright,|,bullets,numbers,table,image,hyperlink,help,showdetails,spellcheck" tabview="no" DEFAULTFONT="8pt Verdana"></cf_activedit>--->
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td></td>
	<td><input type="submit" class="whitefield" value="ADD NOW >>>" onclick="javascript:ae_onSubmit(); validate(LinkAddForm); return false;"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>
