...
<!--- INSERT ARTICLE INFO --->
	...
	INSERT INTO Projects(ProjectID, ProjectCategoryID, Title, introText, Details, AgeShort, AgeLong, ShortTime, MaxTime, CreditsOffered, FeatureProject, currentstatus, percentcomplete, assignedto, paymentType, PaidIn, projectpic, location, project_order, displayProject, addedby)
	VALUES(#newid#, #form.ProjectCategoryID#, '#form.title#', '#form.introtext#', '#form.details#', '#form.AgeShort#', '#form.AgeLong#', '#form.ShortTime#', '#form.MaxTime#', '#form.CreditsOffered#', #form.featureProject#, '#form.currentstatus#', '#form.percentcomplete#', '#form.assignedto#', '#form.PaymentType#', '#form.PaidIn#', '#localImage1#'
