...
<br>
	...
	<cfform name="AddGoal" action="#request.webroot#/admin/act_edit_goal.cfm" method="post">
	...
	<cfloop query="GoalType">
		<option value="#goaltype.GoalTypeID#"<cfif CurrentGoalsDetail.GoalTypeID EQ goaltype.GoalTypeID> selected</cfif>>#goaltype.GoalType#
	</cfloop>
	</select></td>
	</tr>
	...
	<td class="normal" valign="top"><cfinput type="text" required="Yes" message="Please enter your goal title first" value="#TRIM(CurrentGoalsDetail.goaltitle)#" name="GoalTitle" class="whitefield" style="width:350px;"></td>
	</tr>
	...
	<td class="normal" valign="top"><textarea rows="5" style="width:350px;" name="goaldetails">#TRIM(CurrentGoalsDetail.goaldetails)#</textarea></td>
	</tr>
	...
	<td class="normal" valign="top"><cfinput type="text" message="Please enter the display order" required="yes" name="goalorder" size="3" value="#CurrentGoalsDetail.GoalOrder#"></td>
	</tr>
	...
	<td width="10"><img src="#request.imageroot#/transparent_spc.gif" width="10" height="1" border="0"></td>
	<td></td>
	<td><input type="submit" class="whitefield" value="UPDATE NOW >>>" onclick="validate(AddGoal); return false;"> &nbsp; <input type="button" onclick="javascript:window.close();" value="CANCEL >>" class="whitefield"></td>
	</tr>	
