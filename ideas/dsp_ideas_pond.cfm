...
<img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="8"><br>
  <span style="color: ##91AE4E; text-align: center; font-weight: bold; font-size: 17px;"> 
     #viewideas#
  </span>
</td>
...
<td>
	...
	<td width="40" align="left" valign="top"><img src="#request.imageroot#/transparent_spc.gif" width="40" height="1" border="0"><br>
	         <cfif FileExists("#request.fileroot#\images\carcasses_new\#TRIM(qry_current_topic.ideaspic)#")>
					    <img src="#request.imageroot#/carcasses_new/#TRIM(qry_current_topic.ideaspic)#" border="0" title="#TRIM(qry_current_topic.Name)#" alt="#TRIM(qry_current_topic.Name)#" width="220" height="180">
			 <cfelse>
						<img width="220" height="180" src="#request.imageroot#/carcasses_new/no_image.png" class="fl rounded rounded-no-bottom" alt="#TRIM(qry_current_topic.Name)#" title="#TRIM(qry_current_topic.Name)#">		 
			 </cfif> 
	</td>
	<td valign="top" align="right" width="100%">
        ...
        <td align="right" style="font-size:11px;" valign="top"><a href="#request.webroot#/ideas/dsp_topic_stages.cfm?topicID=#this_categoryID#" target="TopicStages" onclick="fdbackwindow=window.open ('','TopicStages','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0,width=600,height=400,top=10,left=10')">#sagesAReward#</a></td>
		</tr>
		...
		<tr>
		<td width="33%" style="color:###TRIM(AllSettings.DkTextColor)#;"><strong>#SponsorText#:</strong> #TRIM(qry_topic_sponsor.Organisation_Name)#</td>
		<td width="33%" style="color:###TRIM(AllSettings.DkTextColor)#;"><strong>#ptsavail#:</strong> #this_pointsremaining#</td>
	...
	<td><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="3"><br>
		...
		<td><img src="#request.imageroot#/transparent_spc.gif" width="1" height="3" border="0"><br>
			...
			<td align="right" class="TableTDBG"><cfif add_idea EQ 0 OR this_pointsremaining EQ 0 OR IsDate("#qry_current_topic.WhenCategoryEnded#") AND dateCompare(localdatetime, qry_current_topic.WhenCategoryEnded) EQ 1><cfelse><cfif session.UserIsAuthenticated EQ 'Yes'><a href="#request.webroot#/index.cfm?fuseaction=ideas&fusesubaction=docs&documentid=76&categoryID=#currentcategory#"><cfelse><a href="javascript:alert('Please login to add your idea.');"></cfif><!---<img src="#request.imageroot#/ideaFunL/new_add_idea.gif" width="101" height="23" alt="Add New Idea" border="0">--->#addnewidea#</a></cfif></td>
			</tr>
		...
		<cfif qry_ideas_pond.RecordCount>
			...
			<td>
				...
				<td width="83%">
					...
					<tr>
					<td width="23" style="background: url(#request.imageroot#/new_vote_yes.gif) ##99CC00 no-repeat; padding-left: 2px;">#yestitle#</td>
					<td width="2"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="17"></td>
					<td width="23" style="background: url(#request.imageroot#/new_vote_no.gif) ##FD7922 no-repeat; padding-left: 2px;">#notitle#</td>
					<td width="2"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="17"></td>
					<td bgcolor="##e2e2e2" style="font-size:11px;color:##444444;padding-left:4px;" valign="middle"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="17" align="absmiddle"><strong><cfif session.UserIsAuthenticated EQ 'Yes'>#ideatitleNote1#<cfelse>#ideatitleNote2#</cfif></strong></td>
					</tr>
				...
				<cfif session.UserIsAuthenticated EQ 'Yes' AND NOT IsDefined("ShowReturned") AND vote_idea EQ 1 AND this_pointsremaining GT 0><td width="2%"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="1"></td>
				<td align="right" width="15%">
				    <a href="javascript: void(0);" onclick="javascript: document.voteform.submit;" style="text-decoration: underline; color: black;">
					    #processvotes#
					</a>
				<!---<input type="image" src="#request.imageroot#/ideaFunL/new_process_votes.gif" width="101" height="23" alt="Process your votes" border="0">---></td>
				</cfif>
				</tr>
			...
			<td style="padding-top:5px;padding-bottom:10px;">
				...
				<tr>
				<td style="color:##444444; font-size:11px;">#allideas#:&nbsp; <strong><a href="##" onClick="OpenAllIdeas(); return false;" style="color:##444444;">#OPEN#</a> | <a href="##" onClick="CloseAllIdeas(); return false;" style="color:##444444;">#CLOSE#</a></strong></td>
				<td align="right" style="color:##444444; font-size:11px;"><cfif session.UserIsAuthenticated EQ 'Yes'>#ideasvoted#:&nbsp; <cfif session.IdeaFunL_hideIdeas EQ 'Yes'><a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&IdeaFunL_StartRow=1&currentcategory=#currentcategory#&documentID=75&IdeaFunL_hideIdeas=No<cfif IsDefined('returnIdeas') AND returnIdeas NEQ ''>&returnIdeas=#returnIdeas#</cfif><cfif IsDefined("ShowReturned")>&ShowReturned=1</cfif><cfif IsDefined("ShowPending")>&ShowPending=1</cfif>" style="color:##444444;"><strong>#showtext#</strong></a></cfif><cfif session.IdeaFunL_hideIdeas EQ 'No'><a href="#request.webroot#/index.cfm?Fuseaction=#Fuseaction#&Fusesubaction=#Fusesubaction#&IdeaFunL_StartRow=1&currentcategory=#currentcategory#&documentID=75&IdeaFunL_hideIdeas=Yes<cfif IsDefined('returnIdeas') AND returnIdeas NEQ ''>&returnIdeas=#returnIdeas#</cfif><cfif IsDefined("ShowReturned")>&ShowReturned=1</cfif><cfif IsDefined("ShowPending")>&ShowPending=1</cfif>" style="color:##444444;"><strong>#hidetext#</strong></a></cfif></cfif></td>
				</tr>
			...
			<cfif (session.UserIsAuthenticated EQ 'Yes') AND ((qry_user_vote.RecordCount) OR (this_ContactID EQ session.UserID) OR (session.UserType EQ 'Administrator'))>
				...
				<td style="padding-top:3px;">			
					...
					<td width="100%" style="padding-left:10px;">
						...
						<td style="font-size:11px;color:##444444;" width="120"><strong>% #yestitle#:&nbsp;</strong> #NumberFormat(PercentYes, "0.0")#%</td>
						<cfif session.userID NEQ this_contactID><td style="font-size:11px;color:##444444;" width="100"><strong>#yourvote#:&nbsp;</strong> <cfif qry_user_vote.Vote GT 1>YES<cfelse>NO</cfif></td></cfif>
						</tr>
			...
			<td style="display:none;" id="idea#this_SugID#">
				...
				<td width="100%" style="padding-left:3px;"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="50" height="4"><br>
                    ...
                    <cfif this_details NEQ ''>
						<tr>
						<td colspan="3"><strong>#addprojdetails#:&nbsp;</strong> #this_details#</td>
						</tr>
					</cfif>		
				...
				<cfif (session.UserIsAuthenticated EQ 'no') OR ((IsDefined("qry_user_vote") AND qry_user_vote.RecordCount LT 1 AND this_ContactID NEQ session.UserID)) AND NOT IsDefined("ShowReturned") AND NOT IsDefined("ShowPending") AND vote_idea EQ 1 AND this_pointsremaining GT 0>
					...
					<tr>
					<td width="23" align="center" style="font-size:11px;color:##666666;">#yestitle#</td>
					<td width="2"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="1"></td>
					<td width="23" align="center" style="font-size:11px;color:##666666;">#notitle#</td>
					<td width="2"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="1"></td>
		...
		<td style="padding-top:10px;">
			...
			<td width="83%">
				...
				<td width="23" style="background: url(#request.imageroot#/new_vote_yes.gif) ##99CC00 no-repeat; padding-left: 2px;">#yestitle#</td>
					...
					<td width="23" style="background: url(#request.imageroot#/new_vote_no.gif) ##FD7922 no-repeat; padding-left: 2px;">#notitle#</td>
				<td width="2"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="17"></td>
				<td bgcolor="##e2e2e2" style="font-size:11px;color:##444444;padding-left:4px;" valign="middle"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="17" align="absmiddle"><strong><cfif session.UserIsAuthenticated EQ 'Yes'>#ideatitleNote3#<cfelse>#ideatitleNote4#</cfif></strong></td>
				</tr>
			...
			<cfif session.UserIsAuthenticated EQ 'Yes' AND NOT IsDefined("ShowReturned") AND vote_idea EQ 1 AND this_pointsremaining GT 0><td width="2%"><img src="#request.imageroot#/transparent_spc.gif" border="0" width="1" height="1"></td>
				<td align="right" width="15%">
						<a href="javascript: void(0);" style="color: black; text-decoration: underline;" onclick="javascript: document.voteform.submit;">
							#processvotes#
						</a>
					<!---<input type="image" src="#request.imageroot#/ideaFunL/new_process_votes.gif" width="101" height="23" alt="Process your votes" border="0">--->
				</td>
			</cfif>
			</tr>
	...
	<cfelse>
		...
		<tr>
		<td><strong>#ideatitleNote5#</strong></td>
		</tr>
