...
<cfif IsDefined("URL.categoryID") AND IsNumeric("#URL.categoryID#")>
	WHERE MainCatID=#URL.categoryID#
<cfelseif IsDefined("session.MainCatID") AND IsNumeric("#session.MainCatID#")>	
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
       <td>
	          <a href="#request.webroot#/index.cfm?fuseaction=ideas&fusesubaction=docs&documentID=75"><img src="#request.imageroot#/ideaFunL/new_3_1_add.gif" width="35" height="52" alt="1. Select a topic" border="0"></a><a href="#request.webroot#/index.cfm?fuseaction=ideas&fusesubaction=docs&documentID=75&currentcategory=#CategoryID#"><img src="#request.imageroot#/ideaFunL/new_3_2_add.gif" width="46" height="52" alt="2. View Ideas" border="0"></a><img src="#request.imageroot#/ideaFunL/new_3_3_add.gif" width="67" height="52" alt="3. ADD AN IDEA" border="0"><br>
				<div style="color: ##91AE4E; font-size: 17px; font-weight: bold; text-align: justify;">
					#addanidea#
				</div>
	   </td>  
  </tr>
  <tr>
       <td>
			  ...
			  <div style="background: none repeat scroll 0 0 ##000000; color: ##FFFFFF; font-size: 17px; padding: 10px 10px 1px; width: 46%;">
			     #addideatext1#<br />
				 <ol>
				   <li> #addideatext2# </li>
				   <li> #addideatext3# </li>
              ...
              <!---<img src="#request.imageroot#/ideaFunl_Process.gif" width="484" height="111" border="0">---> 
			  </div>
			  <div style="margin-top: 10px">
					#addideatext5# #addideatext6# #addideatext7#  
			  </div>		
	   </td> 
  </tr>
</table> 
...
<tr>
<td><br> 
          <div style="background: white; width: 280px">
		       <img src="#request.imageroot#/ideaFunL/a_vote_blank.gif" width="50" alt="STEP 1 - Vote on new ideas" border="0" align="absmiddle">
			   <span style="font-size: 17px; font-weight: bold; margin-top: 10px;"> 
				    #votenewideas#
			   </span>		
		  </div>
    <br> 
	...
	<cfelse>
		...
		<tr>
		<td><img src="#request.imageroot#/transparent_spc.gif" border="0" width="45"></td>
		<td width="100%" style="color:###TRIM(AllSettings.DkTextColor)#;" valign="top"><strong>#nopendingtxt#<br>
		#nopendingtxt2#!</strong></td>
		</tr>
...
<td width="100%"><br>
      ...
      <div style="background: white; width: 250px">
		   <img src="#request.imageroot#/ideaFunL/b_enteridea_blank.gif" width="50" alt="STEP 2 - Enter Your Idea" border="0" align="absmiddle">
		   <span style="font-size: 17px; font-weight: bold; margin-top: 10px;"> 
				#enteridea1#
		   </span>		
	  </div>
	  
       <!--- <img src="#request.imageroot#/ideaFunL/b_enteridea.gif" width="178" height="36" alt="STEP 2 - Enter Your Idea" border="0">--->
	...
	<td width="100%">
	    ...
	    <input type="hidden" name="this_categoryID" value="#URL.categoryID#">
		...
		<tr>
		<td colspan="2"><span style="color:###TRIM(AllSettings.DkTextColor)#;font-size:11px;"><strong>#pleasenote#:</strong> &nbsp;#pleasenote2#.</span>
		<hr width="100%" size="1" color="##e2e2e2"></td>
		</tr>
		
		<tr>
		<td style="padding-right:10px;color:###TRIM(AllSettings.DkTextColor)#" width="125"><strong>#ideacate#:</strong></td>
		...
		<tr> 		
		<td style="padding-right:10px;color:###TRIM(AllSettings.DkTextColor)#;" width="125"><strong>#ideatopic#</strong></td>
		...
		<option value="0">#pickupanideacate#</option>
		...
		<tr> 		
		<td style="padding-right:10px;color:###TRIM(AllSettings.DkTextColor)#;" valign="top" width="125"><strong>#summmax#</strong></td>
		...
		<tr> 		
		<td style="padding-right:10px;color:###TRIM(AllSettings.DkTextColor)#;" valign="top" width="125"><strong>#addprojdetails#</strong></td>
		...
		<td valign="top"><input type="submit" value="#castvoteidea#" style="font-size:11px;" class="whitefield"></td>
		</tr>
