<cfquery name="qry_all_category_suggestions" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
...
<cfquery name="AllPointsEarned" datasource="#dsn#" username="mykidsbiznew" password="u+67eNfJ">
