...
<cfquery name="CheckUserEmail" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
SELECT ContactID
FROM Contacts
...
AND EmailAddress <>''
	...
	<cfif #CheckUserEmail.RecordCount# GT 0>
			...
			self.location="#request.webroot#/index.cfm?fuseaction=projects&projectmode=template&ProjectCategoryID=1&ProjectID=3";
			</script>
			</cfoutput>
			<cfabort>
		<cfelse>
		...
		<cfquery name="AddContact" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfquery name="LastLinkID" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r" maxrows="1">
		...
		<cfquery name="AddLink" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
		...
		<cfquery name="AddSurvey" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
...
<cfquery name="kidsdetails" datasource="#dsn#" username="mykidsbizcom" password="w29snfc66r">
