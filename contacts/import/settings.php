...
$tofield = "alan@my3p.com"; #you must enter (your) email address here otherwise mail won't be sent
...
$available_scripts = array("Yahoo", "Hotmail", "Gmail", "AOL", "MSN");
$scripts = array();
...
$logo = "<img src=\"{$logofile}\">";

$formdisclaimer = "<em>Note: Your username and password will not be stored on this server.</em>";
