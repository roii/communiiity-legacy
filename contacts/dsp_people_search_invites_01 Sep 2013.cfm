...
<td style="padding-left:5px;">[e] <a href="mailto:#TRIM(PendingResults.InvitationToEmail)#" style="text-decoration:none;color:###TRIM(AllSettings.BoxColour)#" title="#TRIM(PendingResults.InvitationToEmail)#">#TRIM(PendingResults.InvitationToEmail)#</a></td>
