...
SELECT *
FROM Settings
WHERE ParserURL LIKE '%www.my3p.com%' 
</cfquery>
...
<html>
<head>
	<title>www.communiiity.com submit interest</title>
</head>
...
project id: #trim(form.projectid)#
...
Your interest in this project has been email to the administrator and cc'd to you. You can now close this window.
