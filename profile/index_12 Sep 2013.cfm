...
<cfelseif attributes.fusesubaction EQ 'docs'>
	...
	<cfelseif documentID EQ 41>	
	    <cfparam name="mode" default="profile">
		
        <cfif mode EQ 'profile'>
            <cfinclude template="dsp_profile_images.cfm">
		<cfelse>
            <cfinclude template="dsp_profile_personal.cfm">
        </cfif>
        
	<cfelseif documentID EQ 42>	
	
		<cfinclude template="dsp_account_details.cfm">
		
	<cfelseif documentID EQ 90>	
	
		<cfinclude template="dsp_shipping_details.cfm">
		
	<cfelseif documentID EQ 92>	
	
		<cfinclude template="dsp_dashboard.cfm">
		
	<cfelseif documentID EQ 95>	
	
		<cfinclude template="dsp_resources.cfm">
