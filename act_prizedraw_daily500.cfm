...
<cfquery name="PrizeDetails" datasource="#dsn#" username="#request.username#" password="#request.password#" maxrows="1">
SELECT * 
FROM prize_pool
WHERE Daily500=1
AND Status=0
...
VALUES(#newid#, '500 Points', 0, #CreateODBCDate(this_start)#, #CreateODBCDate(this_end)#, 500, 1, 0, 0, 0, 0, 0, 1, 0, 'thumb_Points80x80.jpg', 0, 0)
 ...
 <cfquery name="NewDraw" datasource="#dsn#" username="#request.username#" password="#request.password#" maxrows="1">
SELECT * 
FROM prize_pool
WHERE Daily500=1
AND Status=0
