...
<cfmail to="#TRIM(ContactDetails.EmailAddress)#" from="#TRIM(AllSettings.EmailAlertFrom)#" subject="Welcome to communautiii.com" type="html">
<!DOCType HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
...
<cfmail to="#TRIM(ContactDetails.EmailAddress)#" from="#TRIM(AllSettings.EmailAlertFrom)#" subject="#TRIM(NewAlertSubject)#">#TRIM(NewAlertDetails)#</cfmail>
