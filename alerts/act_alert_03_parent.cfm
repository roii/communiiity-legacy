...
<!--- SEND THE HTML EMAIL --->				
<cfmail to="#TRIM(ContactDetails.ParentsEmail)#" from="#TRIM(AllSettings.EmailAlertFrom)#" subject="#TRIM(NewAlertSubject)#" Type="HTML">
...
<cfmail to="#TRIM(ContactDetails.ParentsEmail)#" from="#TRIM(AllSettings.EmailAlertFrom)#" subject="#TRIM(NewAlertSubject)#">#TRIM(NewAlertDetails)#</cfmail>
