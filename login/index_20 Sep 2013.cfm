						...
						<tr>
							  ...
							  <table cellpadding="0" cellspacing="0" border="0" width="100%">
								 <form method="post" action="#request.webroot#/index.cfm" onSubmit="validatePageLogin(PageLoginForm); return false;" name="PageLoginForm">
										<tr>
												<td>Email Address: <input type="text" class="field" name="LoginName" style="width:100px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Password: <input type="password" class="field" name="Password" style="width:100px;"> &nbsp; <input type="submit" class="field" value="Login Now">
												 <br> or <br>
												    <span style="color:##000; font-family: Verdana,Geneva,sans-serif; font-size: small;">
									                    sign in with <a href="javascript: void(0);" onclick="javascript: window.open('/getRequestToken.cfm','linkedIn Login','width=800,height=600,scrollbars=1,resizable=1');"> 
														<img src="/images/linkedin-icon-footer.png" style="height: 20px; margin: 0; padding: 0;" /></a>
									                </span> 
												</td>
										</tr>
										...
										<tr>
												<td><hr width="50%" size="1" color="e2e2e2">
													<a href="#request.webroot#/dsp_forgot_password.cfm" target="password" onClick="fdbackwindow=window.open ('','password','width=500,height=240,top=10,left=10,resizable=1,menubar=0,status=0,scrollbars=1,panel=0,addressbar=0')">Forgot Password</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="#request.webroot#/index.cfm?fuseaction=join">Register</a> 
												</td>
										</tr>
