...
<cfif photo_upload_name NEQ ''>
	...
	<cfx_image action="resize" file="#request.fileroot#\images\alantest\#photo_upload_name#" output="#request.fileroot#\images\alantest_full\#photo_upload_name#" quality="75" x="300" y="200">

	<cfx_image action="resize" file="#request.fileroot#\images\alantest\#photo_upload_name#" output="#request.fileroot#\images\alantest_thumb\#photo_upload_name#" quality="75" x="80" y="60"> 
