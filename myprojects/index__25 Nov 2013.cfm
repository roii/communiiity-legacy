...
<cfif IsDefined("URL.campID") and URL.campID neq ''> 
    <cfset campaign_id = Replace(#TRIM(URL.campID)#, "-", " ", "ALL")>  
		...
		<title>
		   ...
		   <cfelse>
		        #TRIM(AllSettings.SiteName)# | Campaign Page
		   </cfif>
		</title>
<cfelse> 
        <title><cfif IsDefined("this_metatitle") and this_metatitle neq ''>#TRIM(this_metatitle)#<cfelse>#TRIM(AllSettings.SiteName)# - Campaign Page
		</cfif></title>
</cfif>
